...
```sh
yarn add scong-react-fork-pdf-render
```

## How it works

```js
const render = require('scong-react-fork-pdf-render');
const primitives = require('scong-react-fork-pdf-primitives');
...
Mandatory field specifiying the type of the particular node. The full list of types can be found and imported from `scong-react-fork-pdf-primitives`
...
const fs = require('fs');
const render = require('scong-react-fork-pdf-render');
const pdfkit = require('scong-react-fork-pdf-pdfkit');
