import e from '@babel/runtime/helpers/inheritsLoose';
import t from '@babel/runtime/helpers/assertThisInitialized';
import r from 'pako/lib/zlib/zstream';
import n from 'pako/lib/zlib/deflate.js';
import i from 'pako/lib/zlib/inflate.js';
import o from 'pako/lib/zlib/constants';
import a from '@babel/runtime/helpers/createForOfIteratorHelperLoose';
import c from '@babel/runtime/helpers/createClass';
import s from 'crypto-js/md5';
import * as u from 'fontkit';
import l from '@react-pdf/png-js';
import f from '@babel/runtime/helpers/extends';
import * as h from 'crypto-js/core';
var d =
...
function A(e) {
  ...
  y || v();
  for (
    var r = e.length, n = r % 3, i = '', o = [], a = 16383, c = 0, s = r - n;
    c < s;
    c += a
  )
    o.push(b(e, c, c + a > s ? s : c + a));
  return (
    1 === n
      ? ((t = e[r - 1]), (i += m[t >> 2]), (i += m[(t << 4) & 63]), (i += '=='))
      : 2 === n &&
        ((t = (e[r - 2] << 8) + e[r - 1]),
        (i += m[t >> 10]),
        (i += m[(t >> 4) & 63]),
      ...
      isNaN(t) || t === 1 / 0
        ...
        : ((a = Math.floor(Math.log(t) / Math.LN2)),
          ...
          a + f >= l
            ? ((c = 0), (a = l))
            : a + f >= 1
            ? ((c = (t * s - 1) * Math.pow(2, i)), (a += f))
            : ((c = t * Math.pow(2, f - 1) * Math.pow(2, i)), (a = 0)));
    i >= 8;
    e[r + d] = 255 & c, d += m, c /= 256, i -= 8
  );
  for (
    a = (a << i) | c, u += i;
    u > 0;
    e[r + d] = 255 & a, d += m, a /= 256, u -= 8
  );
  e[r + d - m] |= 128 * g;
}
var O = {}.toString,
...
function T(e, t) {
  ...
  return (
    x.TYPED_ARRAY_SUPPORT
      ? ((e = new Uint8Array(t)).__proto__ = x.prototype)
      : (null === e && (e = new x(t)), (e.length = t)),
    e
  );
}
function x(e, t, r) {
  if (!(x.TYPED_ARRAY_SUPPORT || this instanceof x)) return new x(e, t, r);
  if ('number' == typeof e) {
    if ('string' == typeof t)
      throw new Error(
...
function k(e, t, r, n) {
  ...
  return 'undefined' != typeof ArrayBuffer && t instanceof ArrayBuffer
    ...
    : (function(e, t) {
        if (F(t)) {
          var r = 0 | P(t.length);
          return 0 === (e = T(e, r)).length || t.copy(e, 0, 0, r), e;
        }
        if (t) {
          if (
...
function U(e, t) {
  if ((R(t), (e = T(e, t < 0 ? 0 : 0 | P(t))), !x.TYPED_ARRAY_SUPPORT))
...
function j(e, t, r, n, i) {
  ...
  if (('string' == typeof t && (t = x.from(t, n)), F(t)))
    return 0 === t.length ? -1 : N(e, t, r, n, i);
  if ('number' == typeof t)
    return (
      (t &= 255),
      x.TYPED_ARRAY_SUPPORT && 'function' == typeof Uint8Array.prototype.indexOf
        ? i
...
function B(e, t, r, n) {
  return se(ae(t, e.length - r), e, r, n);
}
function Y(e, t, r, n) {
  return se(
    (function(e) {
...
function V(e, t, r) {
  return 0 === t && r === e.length ? A(e) : A(e.slice(t, r));
}
function G(e, t, r) {
...
(x.TYPED_ARRAY_SUPPORT =
  void 0 === d.TYPED_ARRAY_SUPPORT || d.TYPED_ARRAY_SUPPORT),
  (x.poolSize = 8192),
  (x._augment = function(e) {
    return (e.__proto__ = x.prototype), e;
  }),
  (x.from = function(e, t, r) {
    return k(null, e, t, r);
  }),
  x.TYPED_ARRAY_SUPPORT &&
    ((x.prototype.__proto__ = Uint8Array.prototype),
    (x.__proto__ = Uint8Array)),
  (x.alloc = function(e, t, r) {
  ...
  (x.allocUnsafe = function(e) {
    return U(null, e);
  }),
  (x.allocUnsafeSlow = function(e) {
    return U(null, e);
  }),
  ...
  (x.compare = function(e, t) {
    if (!F(e) || !F(t)) throw new TypeError('Arguments must be Buffers');
    if (e === t) return 0;
  ...
  (x.concat = function(e, t) {
    ...
    if (0 === e.length) return x.alloc(0);
    var r;
    if (void 0 === t) for (t = 0, r = 0; r < e.length; ++r) t += e[r].length;
    var n = x.allocUnsafe(t),
      i = 0;
  ...
  (x.prototype.equals = function(e) {
    ...
    return this === e || 0 === x.compare(this, e);
  }),
  ...
  (x.prototype.compare = function(e, t, r, n, i) {
    if (!F(e)) throw new TypeError('Argument must be a Buffer');
    if (
      (void 0 === t && (t = 0),
  ...
  (x.prototype.includes = function(e, t, r) {
  ...
  (x.prototype.write = function(e, t, r, n) {
...
function $(e, t, r, n, i, o) {
  if (!F(e)) throw new TypeError('"buffer" argument must be a Buffer instance');
...
function re(e, t, r, n, i) {
  return i || te(e, 0, r, 4), _(e, t, r, n, 23, 4), r + 4;
}
function ne(e, t, r, n, i) {
  return i || te(e, 0, r, 8), _(e, t, r, n, 52, 8), r + 8;
}
(x.prototype.slice = function(e, t) {
  ...
  if (
    ...
    (r = this.subarray(e, t)).__proto__ = x.prototype;
  else {
    var i = t - e;
    r = new x(i, void 0);
  ...
  (x.prototype.readFloatLE = function(e, t) {
    return t || X(e, 4, this.length), w(this, e, !0, 23, 4);
  }),
  (x.prototype.readFloatBE = function(e, t) {
    return t || X(e, 4, this.length), w(this, e, !1, 23, 4);
  }),
  (x.prototype.readDoubleLE = function(e, t) {
    return t || X(e, 8, this.length), w(this, e, !0, 52, 8);
  }),
  (x.prototype.readDoubleBE = function(e, t) {
    return t || X(e, 8, this.length), w(this, e, !1, 52, 8);
  }),
  (x.prototype.writeUIntLE = function(e, t, r, n) {
    ((e = +e), (t |= 0), (r |= 0), n) ||
  ...
  (x.prototype.writeUIntBE = function(e, t, r, n) {
    ((e = +e), (t |= 0), (r |= 0), n) ||
      $(this, e, t, r, Math.pow(2, 8 * r) - 1, 0);
    var i = r - 1,
      o = 1;
  ...
  (x.prototype.writeUInt8 = function(e, t, r) {
    return (
      ...
      (t |= 0),
      r || $(this, e, t, 1, 255, 0),
      x.TYPED_ARRAY_SUPPORT || (e = Math.floor(e)),
      (this[t] = 255 & e),
      t + 1
    );
  }),
  ...
  (x.prototype.writeIntLE = function(e, t, r, n) {
    if (((e = +e), (t |= 0), !n)) {
  ...
  (x.prototype.writeIntBE = function(e, t, r, n) {
    if (((e = +e), (t |= 0), !n)) {
      var i = Math.pow(2, 8 * r - 1);
      $(this, e, t, r, i - 1, -i);
    }
  ...
  (x.prototype.writeFloatLE = function(e, t, r) {
    return re(this, e, t, !0, r);
  }),
  (x.prototype.writeFloatBE = function(e, t, r) {
    return re(this, e, t, !1, r);
  }),
  (x.prototype.writeDoubleLE = function(e, t, r) {
    return ne(this, e, t, !0, r);
  }),
  (x.prototype.writeDoubleBE = function(e, t, r) {
    return ne(this, e, t, !1, r);
  }),
  (x.prototype.copy = function(e, t, r, n) {
    if (
      (r || (r = 0),
      n || 0 === n || (n = this.length),
  ...
  (x.prototype.fill = function(e, t, r, n) {
    if ('string' == typeof e) {
      if (
        ('string' == typeof t
      ...
      if ('string' == typeof n && !x.isEncoding(n))
    ...
    if (
      ...
      var a = F(e) ? e : ae(new x(e, n).toString()),
        c = a.length;
...
function ce(e) {
  return (function(e) {
    ...
    for (t = 0, r = 0; t < n; t += 4, r += 3)
      (i =
        (g[e.charCodeAt(t)] << 18) |
        (g[e.charCodeAt(t + 1)] << 12) |
        (g[e.charCodeAt(t + 2)] << 6) |
        g[e.charCodeAt(t + 3)]),
        (a[s++] = (i >> 16) & 255),
        (a[s++] = (i >> 8) & 255),
        (a[s++] = 255 & i);
    return (
      2 === o
        ? ((i = (g[e.charCodeAt(t)] << 2) | (g[e.charCodeAt(t + 1)] >> 4)),
          (a[s++] = 255 & i))
        : 1 === o &&
          ((i =
            (g[e.charCodeAt(t)] << 10) |
            (g[e.charCodeAt(t + 1)] << 4) |
            (g[e.charCodeAt(t + 2)] >> 2)),
          (a[s++] = (i >> 8) & 255),
          (a[s++] = 255 & i)),
      a
    );
...
'function' == typeof d.setTimeout && (pe = setTimeout),
  'function' == typeof d.clearTimeout && (ye = clearTimeout);
var be,
  Ae = [],
  we = !1,
  _e = -1;
function Oe() {
  we &&
    be &&
    ((we = !1),
    be.length ? (Ae = be.concat(Ae)) : (_e = -1),
    Ae.length && Se());
}
function Se() {
  if (!we) {
    ...
    for (var t = Ae.length; t; ) {
      for (be = Ae, Ae = []; ++_e < t; ) be && be[_e].run();
      (_e = -1), (t = Ae.length);
    }
    (be = null),
      (we = !1),
      (function(e) {
        if (ye === clearTimeout) return clearTimeout(e);
        if ((ye === ge || !ye) && clearTimeout)
...
var je,
  Ne = {
    nextTick: function(e) {
      ...
      Ae.push(new Ee(e, t)), 1 !== Ae.length || we || ve(Se);
    },
    title: 'browser',
    browser: !0,
    env: {},
  ...
  (Me.exports.once = function(e, t) {
    return new Promise(function(r, n) {
      ...
      Qe(e, t, o, { once: !0 }),
        'error' !== t &&
          (function(e, t, r) {
            'function' == typeof e.on && Qe(e, 'error', t, r);
          })(e, i, { once: !0 });
    });
  }),
  (qe.EventEmitter = qe),
...
function Ge(e) {
  return void 0 === e._maxListeners ? qe.defaultMaxListeners : e._maxListeners;
}
function Ke(e, t, r, n) {
  var i, o, a, c;
  if (
...
Object.defineProperty(qe, 'defaultMaxListeners', {
  ...
  (qe.prototype.emit = function(e) {
    ...
    if ('function' == typeof c) Ye(c, this, t);
    else {
      var s = c.length,
        u = $e(c, s);
      for (r = 0; r < s; ++r) Ye(u[r], this, t);
    }
    return !0;
  }),
  ...
  (qe.prototype.prependListener = function(e, t) {
    return Ke(this, e, t, !0);
  }),
  (qe.prototype.once = function(e, t) {
    return Ve(t), this.on(e, Ze(this, e, t)), this;
  }),
  (qe.prototype.prependOnceListener = function(e, t) {
    return Ve(t), this.prependListener(e, Ze(this, e, t)), this;
  }),
  (qe.prototype.removeListener = function(e, t) {
    var r, n, i, o, a;
    if ((Ve(t), void 0 === (n = this._events))) return this;
...
for (
  var et = Me.exports.EventEmitter,
    ...
    rt = {
      ...
      toByteArray: function(e) {
        ...
        for (r = 0; r < s; r += 4)
          (t =
            (it[e.charCodeAt(r)] << 18) |
            (it[e.charCodeAt(r + 1)] << 12) |
            (it[e.charCodeAt(r + 2)] << 6) |
            it[e.charCodeAt(r + 3)]),
            (a[c++] = (t >> 16) & 255),
            (a[c++] = (t >> 8) & 255),
            (a[c++] = 255 & t);
        2 === o &&
          ((t = (it[e.charCodeAt(r)] << 2) | (it[e.charCodeAt(r + 1)] >> 4)),
          (a[c++] = 255 & t));
        1 === o &&
          ((t =
            (it[e.charCodeAt(r)] << 10) |
            (it[e.charCodeAt(r + 1)] << 4) |
            (it[e.charCodeAt(r + 2)] >> 2)),
          (a[c++] = (t >> 8) & 255),
          (a[c++] = 255 & t));
        return a;
      },
      fromByteArray: function(e) {
        for (
          var t, r = e.length, n = r % 3, i = [], o = 16383, a = 0, c = r - n;
          a < c;
          a += o
        )
          i.push(lt(e, a, a + o > c ? c : a + o));
        1 === n
          ? ((t = e[r - 1]), i.push(nt[t >> 2] + nt[(t << 4) & 63] + '=='))
          : 2 === n &&
            ((t = (e[r - 2] << 8) + e[r - 1]),
            i.push(nt[t >> 10] + nt[(t >> 4) & 63] + nt[(t << 2) & 63] + '='));
        return i.join('');
      }
    },
    nt = [],
  ...
  (nt[ct] = at[ct]), (it[at.charCodeAt(ct)] = ct);
function ut(e) {
  var t = e.length;
  if (t % 4 > 0)
    throw new Error('Invalid string. Length must be a multiple of 4');
...
!(function(e) {
  ...
  function c(e, t, r) {
    ...
    var i = (function(e) {
      ...
      if (void 0 !== e.length)
        return 'number' != typeof e.length || B(e.length) ? o(0) : l(e);
  ...
  function l(e) {
    for (
      var t = e.length < 0 ? 0 : 0 | h(e.length), r = o(t), n = 0;
      n < t;
      n += 1
    )
      r[n] = 255 & e[n];
  ...
  (a.prototype.slice = function(e, t) {
    ...
    (a.prototype.readUint16LE = a.prototype.readUInt16LE = function(e, t) {
      return (
        (e >>>= 0), t || U(e, 2, this.length), this[e] | (this[e + 1] << 8)
      );
    }),
    (a.prototype.readUint16BE = a.prototype.readUInt16BE = function(e, t) {
      return (
        (e >>>= 0), t || U(e, 2, this.length), (this[e] << 8) | this[e + 1]
      );
    }),
...
var ht = fe(Object.freeze({ __proto__: null, default: {} }));
function dt(e, t) {
  var r = Object.keys(e);
...
var pt = tt.Buffer,
  yt = ht.inspect,
  vt = (yt && yt.custom) || 'inspect';
function bt(e, t, r) {
  pt.prototype.copy.call(e, t, r);
}
var At = (function() {
  function e() {
    !(function(e, t) {
  ...
  return (
    ...
    (r = [
      ...
      },
      {
        key: 'concat',
        value: function(e) {
          if (0 === this.length) return pt.alloc(0);
          for (var t = pt.allocUnsafe(e >>> 0), r = this.head, n = 0; r; )
            bt(r.data, t, n), (n += r.data.length), (r = r.next);
          return t;
        }
      },
      {
...
function xt(e, t, r) {
  ...
  (n.prototype.name = r.name), (n.prototype.code = e), (Tt[e] = n);
}
function kt(e, t) {
  if (Array.isArray(e)) {
    var r = e.length;
...
xt(
  ...
  xt('ERR_STREAM_PUSH_AFTER_EOF', 'stream.push() after EOF'),
  xt('ERR_METHOD_NOT_IMPLEMENTED', function(e) {
    return 'The ' + e + ' method is not implemented';
  }),
  xt('ERR_STREAM_PREMATURE_CLOSE', 'Premature close'),
  xt('ERR_STREAM_DESTROYED', function(e) {
    return 'Cannot call ' + e + ' after a stream was destroyed';
  }),
  xt('ERR_MULTIPLE_CALLBACK', 'Callback called multiple times'),
  xt('ERR_STREAM_CANNOT_PIPE', 'Cannot pipe, not readable'),
  xt('ERR_STREAM_WRITE_AFTER_END', 'write after end'),
  xt(
  ...
  xt('ERR_STREAM_UNSHIFT_AFTER_END_EVENT', 'stream.unshift() after end event'),
  (Et.codes = Tt);
var Rt = Et.codes.ERR_INVALID_OPT_VALUE;
var Ut = {
    getHighWaterMark: function(e, t, r, n) {
      ...
      if (null != i) {
        if (!isFinite(i) || Math.floor(i) !== i || i < 0)
          throw new Rt(n ? r : 'highWaterMark', i);
        return Math.floor(i);
      }
...
function Lt(e) {
  ...
  switch (
    ((this.encoding = (function(e) {
      ...
      if ('string' != typeof t && (It.isEncoding === Dt || !Dt(e)))
    ...
    case 'utf16le':
      (this.text = Mt), (this.end = Bt), (t = 4);
      break;
    case 'utf8':
      (this.fillLast = Nt), (t = 4);
      break;
    case 'base64':
      (this.text = Yt), (this.end = Wt), (t = 3);
      break;
    default:
      return (this.write = qt), void (this.end = zt);
  }
  (this.lastNeed = 0),
    (this.lastTotal = 0),
    (this.lastChar = It.allocUnsafe(t));
}
function jt(e) {
  return e <= 127
    ? 0
...
(Pt.StringDecoder = Lt),
  ...
  (Lt.prototype.text = function(e, t) {
    var r = (function(e, t, r) {
      ...
      if (--n < r || -2 === i) return 0;
      if ((i = jt(t[n])) >= 0) return i > 0 && (e.lastNeed = i - 2), i;
      if (--n < r || -2 === i) return 0;
      if ((i = jt(t[n])) >= 0)
...
var Vt = Et.codes.ERR_STREAM_PREMATURE_CLOSE;
function Gt() {}
var Kt,
  Ht = function e(t, r, n) {
    ...
    var i = r.readable || (!1 !== r.readable && t.readable),
      ...
      h = function() {
        var e;
        return i && !u
          ? ((t._readableState && t._readableState.ended) || (e = new Vt()),
            n.call(t, e))
          : o && !c
          ? ((t._writableState && t._writableState.ended) || (e = new Vt()),
            n.call(t, e))
          : void 0;
      },
      d = function() {
    ...
    return (
      !(function(e) {
        ...
        ? o && !t._writableState && (t.on('end', a), t.on('close', a))
        : (t.on('complete', s),
          t.on('abort', h),
          t.req ? d() : t.on('request', d)),
      t.on('end', l),
      t.on('finish', s),
      !1 !== r.error && t.on('error', f),
      t.on('close', h),
      function() {
        t.removeListener('complete', s),
          t.removeListener('abort', h),
          t.removeListener('request', d),
          t.req && t.req.removeListener('finish', s),
...
var Jt = Ht,
  Xt = Symbol('lastResolve'),
  $t = Symbol('lastReject'),
  Qt = Symbol('error'),
  er = Symbol('ended'),
  tr = Symbol('lastPromise'),
  rr = Symbol('handlePromise'),
  nr = Symbol('stream');
function ir(e, t) {
...
function or(e) {
  ...
  if (null !== t) {
    var r = e[nr].read();
    null !== r &&
      ((e[tr] = null), (e[Xt] = null), (e[$t] = null), t(ir(r, !1)));
  }
}
function ar(e) {
  Ne.nextTick(or, e);
...
var cr = Object.getPrototypeOf(function() {}),
  sr = Object.setPrototypeOf(
    ((Kt = {
      ...
      next: function() {
        ...
        if (this[er]) return Promise.resolve(ir(void 0, !0));
        if (this[nr].destroyed)
          return new Promise(function(t, r) {
            Ne.nextTick(function() {
              e[Qt] ? r(e[Qt]) : t(ir(void 0, !0));
            });
          });
        var r,
          n = this[tr];
        if (n)
          ...
          var i = this[nr].read();
          if (null !== i) return Promise.resolve(ir(i, !1));
          r = new Promise(this[rr]);
        }
        return (this[tr] = r), r;
      }
    }),
    Zt(Kt, Symbol.asyncIterator, function() {
      return this;
    }),
    Zt(Kt, 'return', function() {
      var e = this;
      return new Promise(function(t, r) {
        e[nr].destroy(null, function(e) {
          e ? r(e) : t(ir(void 0, !0));
        });
      });
    }),
  ...
  ur = function(e) {
    var t,
      r = Object.create(
        sr,
        (Zt((t = {}), nr, { value: e, writable: !0 }),
        Zt(t, Xt, { value: null, writable: !0 }),
        Zt(t, $t, { value: null, writable: !0 }),
        Zt(t, Qt, { value: null, writable: !0 }),
        Zt(t, er, { value: e._readableState.endEmitted, writable: !0 }),
        Zt(t, rr, {
          value: function(e, t) {
            var n = r[nr].read();
            n
              ? ((r[tr] = null), (r[Xt] = null), (r[$t] = null), e(ir(n, !1)))
              : ((r[Xt] = e), (r[$t] = t));
          },
          writable: !0
        }),
    ...
    return (
      ...
      Jt(e, function(e) {
        if (e && 'ERR_STREAM_PREMATURE_CLOSE' !== e.code) {
          ...
          return (
            null !== t &&
              ((r[tr] = null), (r[Xt] = null), (r[$t] = null), t(e)),
            void (r[Qt] = e)
          );
        }
        var n = r[Xt];
        null !== n &&
          ((r[tr] = null), (r[Xt] = null), (r[$t] = null), n(ir(void 0, !0))),
          (r[er] = !0);
      }),
      e.on('readable', ar.bind(null, r)),
      r
    );
  },
  lr = function() {
  ...
  fr = de;
(fr.Readable = Pr), (Pr.ReadableState = Cr), Me.exports.EventEmitter;
var hr = function(e, t) {
    return e.listeners(t).length;
  },
  dr = et,
  mr = tt.Buffer,
  gr = le.Uint8Array || function() {};
var pr,
  yr = ht;
pr = yr && yr.debuglog ? yr.debuglog('stream') : function() {};
var vr,
  br,
  Ar,
  wr = At,
  _r = St,
  Or = Ut.getHighWaterMark,
  Sr = Et.codes,
  Er = Sr.ERR_INVALID_ARG_TYPE,
  Tr = Sr.ERR_STREAM_PUSH_AFTER_EOF,
  xr = Sr.ERR_METHOD_NOT_IMPLEMENTED,
  kr = Sr.ERR_STREAM_UNSHIFT_AFTER_END_EVENT;
Ct.exports(Pr, dr);
var Rr = _r.errorOrDestroy,
  Ur = ['error', 'close', 'destroy', 'pause', 'resume'];
function Cr(e, t, r) {
  (e = e || {}),
    'boolean' != typeof r && (r = t instanceof fr.Duplex),
    (this.objectMode = !!e.objectMode),
    r && (this.objectMode = this.objectMode || !!e.readableObjectMode),
    (this.highWaterMark = Or(this, e, 'readableHighWaterMark', r)),
    (this.buffer = new wr()),
    (this.length = 0),
    (this.pipes = null),
    (this.pipesCount = 0),
    ...
    (this.encoding = null),
    e.encoding &&
      (vr || (vr = Pt.StringDecoder),
      (this.decoder = new vr(e.encoding)),
      (this.encoding = e.encoding));
}
function Pr(e) {
  if (!(this instanceof Pr)) return new Pr(e);
  var t = this instanceof fr.Duplex;
  (this._readableState = new Cr(e, this, t)),
    (this.readable = !0),
    e &&
...
function Fr(e, t, r, n, i) {
  pr('readableAddChunk', t);
  var o,
    a = e._readableState;
  if (null === t)
    (a.reading = !1),
      (function(e, t) {
        if ((pr('onEofChunk'), t.ended)) return;
        if (t.decoder) {
          var r = t.decoder.end();
          r &&
            r.length &&
        ...
        (t.ended = !0),
          t.sync
            ? Lr(e)
            : ((t.needReadable = !1),
              t.emittedReadable || ((t.emittedReadable = !0), jr(e)));
      })(e, a);
  else if (
    (i ||
      (o = (function(e, t) {
        ...
        (n = t),
          mr.isBuffer(n) ||
            ...
            void 0 === t ||
            e.objectMode ||
            (r = new Er('chunk', ['string', 'Buffer', 'Uint8Array'], t));
        var n;
        return r;
      })(a, t)),
    o)
    ...
    if (
      ('string' == typeof t ||
        a.objectMode ||
        Object.getPrototypeOf(t) === mr.prototype ||
        (t = (function(e) {
          return mr.from(e);
        })(t)),
      n)
    )
      a.endEmitted ? Rr(e, new kr()) : Ir(e, a, t, !0);
    else if (a.ended) Rr(e, new Tr());
    else {
      if (a.destroyed) return !1;
      (a.reading = !1),
        a.decoder && !r
          ? ((t = a.decoder.write(t)),
            a.objectMode || 0 !== t.length ? Ir(e, a, t, !1) : Nr(e, a))
          : Ir(e, a, t, !1);
    }
  else n || ((a.reading = !1), Nr(e, a));
...
Object.defineProperty(Pr.prototype, 'destroyed', {
  enumerable: !1,
  get: function() {
  ...
  (Pr.prototype.destroy = _r.destroy),
  (Pr.prototype._undestroy = _r.undestroy),
  (Pr.prototype._destroy = function(e, t) {
    t(e);
  }),
  ...
  (Pr.prototype.unshift = function(e) {
    return Fr(this, e, null, !0, !1);
  }),
  (Pr.prototype.isPaused = function() {
    return !1 === this._readableState.flowing;
  }),
  (Pr.prototype.setEncoding = function(e) {
    vr || (vr = Pt.StringDecoder);
    var t = new vr(e);
...
function Lr(e) {
  ...
  pr('emitReadable', t.needReadable, t.emittedReadable),
    (t.needReadable = !1),
    t.emittedReadable ||
      (pr('emitReadable', t.flowing),
      (t.emittedReadable = !0),
      Ne.nextTick(jr, e));
}
function jr(e) {
  var t = e._readableState;
  pr('emitReadable_', t.destroyed, t.length, t.ended),
    t.destroyed ||
      (!t.length && !t.ended) ||
...
function Nr(e, t) {
  t.readingMore || ((t.readingMore = !0), Ne.nextTick(Mr, e, t));
}
function Mr(e, t) {
  for (
    ;
    ...
    var r = t.length;
    if ((pr('maybeReadMore read 0'), e.read(0), r === t.length)) break;
  }
  t.readingMore = !1;
}
function Br(e) {
...
function Yr(e) {
  pr('readable nexttick read 0'), e.read(0);
}
function Wr(e, t) {
  pr('resume', t.reading),
    t.reading || e.read(0),
...
function qr(e) {
  var t = e._readableState;
  for (pr('flow', t.flowing); t.flowing && null !== e.read(); );
}
function zr(e, t) {
  return 0 === t.length
    ? null
...
function Vr(e) {
  var t = e._readableState;
  pr('endReadable', t.endEmitted),
    t.endEmitted || ((t.ended = !0), Ne.nextTick(Gr, t, e));
}
function Gr(e, t) {
  if (
    (pr('endReadableNT', e.endEmitted, e.length),
    !e.endEmitted &&
      0 === e.length &&
...
(Pr.prototype.read = function(e) {
  pr('read', e), (e = parseInt(e, 10));
  ...
  if (
    ...
    return (
      pr('read: emitReadable', t.length, t.ended),
      0 === t.length && t.ended ? Vr(this) : Lr(this),
      null
    );
  if (0 === (e = Dr(e, t)) && t.ended) return 0 === t.length && Vr(this), null;
  var n,
    i = t.needReadable;
  return (
    pr('need readable', i),
    (0 === t.length || t.length - e < t.highWaterMark) &&
      pr('length less than watermark', (i = !0)),
    t.ended || t.reading
      ? pr('reading or ended', (i = !1))
      : i &&
        (pr('do read'),
        (t.reading = !0),
        (t.sync = !0),
        ...
        (t.sync = !1),
        t.reading || (e = Dr(r, t))),
    null === (n = e > 0 ? zr(e, t) : null)
      ? ((t.needReadable = t.length <= t.highWaterMark), (e = 0))
      : ((t.length -= e), (t.awaitDrain = 0)),
    0 === t.length &&
      (t.ended || (t.needReadable = !0), r !== e && t.ended && Vr(this)),
    null !== n && this.emit('data', n),
    n
  );
}),
  (Pr.prototype._read = function(e) {
    Rr(this, new xr('_read()'));
  }),
  (Pr.prototype.pipe = function(e, t) {
    var r = this,
      n = this._readableState;
    switch (n.pipesCount) {
      case 0:
    ...
    (n.pipesCount += 1), pr('pipe count=%d opts=%j', n.pipesCount, t);
    var i = (!t || !1 !== t.end) && e !== Ne.stdout && e !== Ne.stderr ? a : d;
    function o(t, i) {
      pr('onunpipe'),
        t === r &&
          i &&
    ...
    n.endEmitted ? Ne.nextTick(i) : r.once('end', i), e.on('unpipe', o);
    var c = (function(e) {
      return function() {
        var t = e._readableState;
        pr('pipeOnDrain', t.awaitDrain),
          t.awaitDrain && t.awaitDrain--,
          0 === t.awaitDrain && hr(e, 'data') && ((t.flowing = !0), qr(e));
      };
    })(r);
    e.on('drain', c);
    var s = !1;
      ...
      pr('dest.write', i),
        !1 === i &&
          (((1 === n.pipesCount && n.pipes === e) ||
            (n.pipesCount > 1 && -1 !== Kr(n.pipes, e))) &&
            !s &&
            (pr('false write response, pause', n.awaitDrain), n.awaitDrain++),
          r.pause());
    }
    function l(t) {
      pr('onerror', t),
    ...
    function h() {
      pr('onfinish'), e.removeListener('close', f), d();
    }
    function d() {
      pr('unpipe'), r.unpipe(e);
    }
    return (
      r.on('data', u),
      (function(e, t, r) {
      ...
      e.once('finish', h),
      e.emit('pipe', r),
      n.flowing || (pr('pipe resume'), r.resume()),
      e
    );
  }),
  (Pr.prototype.unpipe = function(e) {
    var t = this._readableState,
      r = { hasUnpiped: !1 };
  ...
  (Pr.prototype.on = function(e, t) {
    var r = dr.prototype.on.call(this, e, t),
      n = this._readableState;
    return (
      'data' === e
        ...
        : 'readable' === e &&
          (n.endEmitted ||
            ...
            (n.flowing = !1),
            (n.emittedReadable = !1),
            pr('on readable', n.length, n.reading),
            n.length ? Lr(this) : n.reading || Ne.nextTick(Yr, this))),
      r
    );
  }),
  (Pr.prototype.addListener = Pr.prototype.on),
  (Pr.prototype.removeListener = function(e, t) {
    var r = dr.prototype.removeListener.call(this, e, t);
    return 'readable' === e && Ne.nextTick(Br, this), r;
  }),
  (Pr.prototype.removeAllListeners = function(e) {
    var t = dr.prototype.removeAllListeners.apply(this, arguments);
    return ('readable' !== e && void 0 !== e) || Ne.nextTick(Br, this), t;
  }),
  (Pr.prototype.resume = function() {
    ...
    return (
      e.flowing ||
        ...
        (function(e, t) {
          t.resumeScheduled ||
            ((t.resumeScheduled = !0), Ne.nextTick(Wr, e, t));
        })(this, e)),
      (e.paused = !1),
      this
    );
  }),
  (Pr.prototype.pause = function() {
    return (
      pr('call pause flowing=%j', this._readableState.flowing),
      !1 !== this._readableState.flowing &&
        (pr('pause'), (this._readableState.flowing = !1), this.emit('pause')),
      (this._readableState.paused = !0),
      this
    );
  }),
  (Pr.prototype.wrap = function(e) {
    var t = this,
      r = this._readableState,
      n = !1;
    for (var i in (e.on('end', function() {
      if ((pr('wrapped end'), r.decoder && !r.ended)) {
        var e = r.decoder.end();
        e && e.length && t.push(e);
      }
      t.push(null);
    ...
    for (var o = 0; o < Ur.length; o++)
      e.on(Ur[o], this.emit.bind(this, Ur[o]));
    return (
      (this._read = function(t) {
        pr('wrapped _read', t), n && ((n = !1), e.resume());
      }),
      this
    );
  }),
  'function' == typeof Symbol &&
    (Pr.prototype[Symbol.asyncIterator] = function() {
      return void 0 === br && (br = ur), br(this);
    }),
  Object.defineProperty(Pr.prototype, 'readableHighWaterMark', {
    enumerable: !1,
    get: function() {
      return this._readableState.highWaterMark;
    }
  }),
  Object.defineProperty(Pr.prototype, 'readableBuffer', {
    enumerable: !1,
    get: function() {
      return this._readableState && this._readableState.buffer;
    }
  }),
  Object.defineProperty(Pr.prototype, 'readableFlowing', {
    enumerable: !1,
    get: function() {
  ...
  (Pr._fromList = zr),
  Object.defineProperty(Pr.prototype, 'readableLength', {
    enumerable: !1,
    get: function() {
  ...
  'function' == typeof Symbol &&
    (Pr.from = function(e, t) {
      return void 0 === Ar && (Ar = lr), Ar(Pr, e, t);
    });
var Hr = function(e, t) {
  if (Zr('noDeprecation')) return e;
  var r = !1;
  return function() {
    if (!r) {
      if (Zr('throwDeprecation')) throw new Error(t);
      Zr('traceDeprecation') ? console.trace(t) : console.warn(t), (r = !0);
    }
...
(Jr.Writable = vn), (vn.WritableState = yn);
var $r = { deprecate: Hr },
  Qr = et,
  en = tt.Buffer,
  tn = le.Uint8Array || function() {};
var rn,
  nn = St,
  on = Ut.getHighWaterMark,
  an = Et.codes,
  cn = an.ERR_INVALID_ARG_TYPE,
  sn = an.ERR_METHOD_NOT_IMPLEMENTED,
  un = an.ERR_MULTIPLE_CALLBACK,
  ln = an.ERR_STREAM_CANNOT_PIPE,
  fn = an.ERR_STREAM_DESTROYED,
  hn = an.ERR_STREAM_NULL_VALUES,
  dn = an.ERR_STREAM_WRITE_AFTER_END,
  mn = an.ERR_UNKNOWN_ENCODING,
  gn = nn.errorOrDestroy;
function pn() {}
function yn(e, t, r) {
  (e = e || {}),
    'boolean' != typeof r && (r = t instanceof Jr.Duplex),
    (this.objectMode = !!e.objectMode),
    r && (this.objectMode = this.objectMode || !!e.writableObjectMode),
    (this.highWaterMark = on(this, e, 'writableHighWaterMark', r)),
    (this.finalCalled = !1),
    (this.needDrain = !1),
    (this.ending = !1),
    (this.ended = !1),
  ...
  (this.decodeStrings = !n),
    ...
    (this.onwrite = function(e) {
      !(function(e, t) {
        var r = e._writableState,
          n = r.sync,
          i = r.writecb;
        if ('function' != typeof i) throw new un();
        if (
          ((function(e) {
            (e.writing = !1),
              (e.writecb = null),
          ...
          var o = _n(r) || e.destroyed;
          o || r.corked || r.bufferProcessing || !r.bufferedRequest || wn(e, r),
            n ? Ne.nextTick(An, e, r, o, i) : An(e, r, o, i);
        }
      })(t, e);
    }),
    (this.writecb = null),
    ...
    (this.corkedRequestsFree = new Xr(this));
}
function vn(e) {
  var t = this instanceof Jr.Duplex;
  if (!t && !rn.call(vn, this)) return new vn(e);
  (this._writableState = new yn(e, this, t)),
    (this.writable = !0),
    e &&
...
function wn(e, t) {
  ...
  if (e._writev && r && r.next) {
    ...
    (i.allBuffers = c),
      bn(e, t, !0, t.length, i, '', o.finish),
      t.pendingcb++,
      (t.lastBufferedRequest = null),
      o.next
        ? ((t.corkedRequestsFree = o.next), (o.next = null))
        : (t.corkedRequestsFree = new Xr(t)),
    ...
    for (; r; ) {
      var s = r.chunk,
        ...
        l = r.callback;
      if (
        (bn(e, t, !1, t.objectMode ? 1 : s.length, s, u, l),
        (r = r.next),
    ...
    ((function(e, t) {
      t.prefinished ||
        ...
        ('function' != typeof e._final || t.destroyed
          ...
          : (t.pendingcb++, (t.finalCalled = !0), Ne.nextTick(On, e, t)));
    })(e, t),
...
Ct.exports(vn, Qr),
  ...
  (function() {
    try {
      Object.defineProperty(yn.prototype, 'buffer', {
        get: $r.deprecate(
          function() {
  ...
  'function' == typeof Function.prototype[Symbol.hasInstance]
    ? ((rn = Function.prototype[Symbol.hasInstance]),
      Object.defineProperty(vn, Symbol.hasInstance, {
        value: function(e) {
          return (
            !!rn.call(this, e) ||
            (this === vn && e && e._writableState instanceof yn)
          );
        }
      }))
    : (rn = function(e) {
  ...
  (vn.prototype.write = function(e, t, r) {
    var n,
      i = this._writableState,
      o = !1,
      a = !i.objectMode && ((n = e), en.isBuffer(n) || n instanceof tn);
    return (
      a &&
        !en.isBuffer(e) &&
        (e = (function(e) {
      ...
      'function' != typeof r && (r = pn),
      i.ending
        ? (function(e, t) {
            var r = new dn();
            gn(e, r), Ne.nextTick(t, r);
          })(this, r)
        : (a ||
            (function(e, t, r, n) {
              var i;
              return (
                null === r
                  ...
                  : 'string' == typeof r ||
                    t.objectMode ||
                    (i = new cn('chunk', ['string', 'Buffer'], r)),
                !i || (gn(e, i), Ne.nextTick(n, i), !1)
              );
            })(this, i, e, r)) &&
          (i.pendingcb++,
  ...
  (vn.prototype.setDefaultEncoding = function(e) {
    if (
  ...
  (vn.prototype._writev = null),
  (vn.prototype.end = function(e, t, r) {
    ...
    return (
      ...
      n.ending ||
        (function(e, t, r) {
          (t.ending = !0),
            Sn(e, t),
            r && (t.finished ? Ne.nextTick(r) : e.once('finish', r));
  ...
  (vn.prototype.destroy = nn.destroy),
  (vn.prototype._undestroy = nn.undestroy),
  (vn.prototype._destroy = function(e, t) {
    t(e);
  });
var En =
    Object.keys ||
  ...
  Tn = de;
(Tn.Duplex = Un), Ct.exports(Un, Tn.Readable);
for (var xn = En(Tn.Writable.prototype), kn = 0; kn < xn.length; kn++) {
  var Rn = xn[kn];
  Un.prototype[Rn] || (Un.prototype[Rn] = Tn.Writable.prototype[Rn]);
}
function Un(e) {
  if (!(this instanceof Un)) return new Un(e);
  Tn.Readable.call(this, e),
    Tn.Writable.call(this, e),
    (this.allowHalfOpen = !0),
    e &&
      (!1 === e.readable && (this.readable = !1),
      !1 === e.writable && (this.writable = !1),
      !1 === e.allowHalfOpen &&
        ((this.allowHalfOpen = !1), this.once('end', Cn)));
}
function Cn() {
  this._writableState.ended || Ne.nextTick(Pn, this);
}
function Pn(e) {
  e.end();
}
...
Fn.Transform = Bn;
var In = Et.codes,
  Dn = In.ERR_METHOD_NOT_IMPLEMENTED,
  Ln = In.ERR_MULTIPLE_CALLBACK,
  jn = In.ERR_TRANSFORM_ALREADY_TRANSFORMING,
  Nn = In.ERR_TRANSFORM_WITH_LENGTH_0;
function Mn(e, t) {
  var r = this._transformState;
  r.transforming = !1;
  var n = r.writecb;
  if (null === n) return this.emit('error', new Ln());
...
function Wn(e, t, r) {
  ...
  if ((null != r && e.push(r), e._writableState.length)) throw new Nn();
  if (e._transformState.transforming) throw new jn();
  return e.push(null);
}
Ct.exports(Bn, Fn.Duplex),
  (Bn.prototype.push = function(e, t) {
    return (
      (this._transformState.needTransform = !1),
      Fn.Duplex.prototype.push.call(this, e, t)
    );
  }),
  (Bn.prototype._transform = function(e, t, r) {
    r(new Dn('_transform()'));
  }),
  (Bn.prototype._write = function(e, t, r) {
  ...
  (Bn.prototype._destroy = function(e, t) {
    Fn.Duplex.prototype._destroy.call(this, e, function(e) {
      t(e);
    });
  });
var qn,
...
(zn.PassThrough = Vn),
  Ct.exports(Vn, zn.Transform),
  (Vn.prototype._transform = function(e, t, r) {
    r(null, e);
  });
var Gn = Et.codes,
  Kn = Gn.ERR_MISSING_ARGS,
  Hn = Gn.ERR_STREAM_DESTROYED;
function Zn(e) {
  if (e) throw e;
}
function Jn(e, t, r, n) {
  ...
  e.on('close', function() {
    ...
    void 0 === qn && (qn = Ht),
    qn(e, { readable: t, writable: r }, function(e) {
      if (e) return n(e);
      (i = !0), n();
    });
  var o = !1;
...
var ei = function() {
  ...
  if ((Array.isArray(t[0]) && (t = t[0]), t.length < 2))
    throw new Kn('streams');
  var o = t.map(function(e, r) {
    var a = r < t.length - 1;
    return Jn(e, a, r > 0, function(e) {
      n || (n = e), e && o.forEach(Xn), a || (o.forEach(Xn), i(n));
    });
  });
  return t.reduce($n);
};
!(function(e, t) {
  var r = de;
  ((t = he.exports = r.Readable).Stream = r.Readable),
...
var ti = he.exports,
  ...
  ui = si,
  li = function() {
    return ui() && !!Symbol.toStringTag;
  },
  fi = 'undefined' != typeof Symbol && Symbol,
  hi = si,
  di = { foo: {} },
  mi = Object,
  gi = 'Function.prototype.bind called on incompatible ',
  pi = Array.prototype.slice,
  yi = Object.prototype.toString,
  vi = function(e) {
    var t = this;
    if ('function' != typeof t || '[object Function]' !== yi.call(t))
      throw new TypeError(gi + t);
    for (
      var r,
        n = pi.call(arguments, 1),
        i = function() {
          if (this instanceof r) {
            var i = t.apply(this, n.concat(pi.call(arguments)));
            return Object(i) === i ? i : this;
          }
          return t.apply(e, n.concat(pi.call(arguments)));
        },
  ...
  bi = Function.prototype.bind || vi,
  Ai = bi.call(Function.call, Object.prototype.hasOwnProperty),
  wi = SyntaxError,
  _i = Function,
  Oi = TypeError,
  Si = function(e) {
    try {
      return _i('"use strict"; return (' + e + ').constructor;')();
    } catch (e) {}
  },
...
var Ti = function() {
  ...
  ki =
    'function' == typeof fi &&
    'function' == typeof Symbol &&
    'symbol' == typeof fi('foo') &&
    'symbol' == typeof Symbol('bar') &&
    hi(),
  Ri = { __proto__: di }.foo === di.foo && !({ __proto__: null } instanceof mi),
  Ui =
    ...
    (Ri
      ...
      : null),
  Ci = {},
  Pi = 'undefined' != typeof Uint8Array && Ui ? Ui(Uint8Array) : undefined,
  Fi = {
    '%AggregateError%':
    ...
    '%ArrayIteratorPrototype%':
      ki && Ui ? Ui([][Symbol.iterator]()) : undefined,
    '%AsyncFromSyncIteratorPrototype%': undefined,
    '%AsyncFunction%': Ci,
    '%AsyncGenerator%': Ci,
    '%AsyncGeneratorFunction%': Ci,
    '%AsyncIteratorPrototype%': Ci,
    '%Atomics%': 'undefined' == typeof Atomics ? undefined : Atomics,
    '%BigInt%': 'undefined' == typeof BigInt ? undefined : BigInt,
    '%BigInt64Array%':
      'undefined' == typeof BigInt64Array ? undefined : BigInt64Array,
    '%BigUint64Array%':
      'undefined' == typeof BigUint64Array ? undefined : BigUint64Array,
    '%Boolean%': Boolean,
    ...
    '%isFinite%': isFinite,
    '%isNaN%': isNaN,
    '%IteratorPrototype%': ki && Ui ? Ui(Ui([][Symbol.iterator]())) : undefined,
    '%JSON%': 'object' == typeof JSON ? JSON : undefined,
    '%Map%': 'undefined' == typeof Map ? undefined : Map,
    '%MapIteratorPrototype%':
      'undefined' != typeof Map && ki && Ui
        ? Ui(new Map()[Symbol.iterator]())
        : undefined,
    '%Math%': Math,
    '%Number%': Number,
    '%Object%': Object,
    ...
    '%SetIteratorPrototype%':
      'undefined' != typeof Set && ki && Ui
        ? Ui(new Set()[Symbol.iterator]())
        : undefined,
    '%SharedArrayBuffer%':
...
if (Ui)
  try {
    ...
    var Ii = Ui(Ui(e));
    Fi['%Error.prototype%'] = Ii;
  }
var Di = function e(t) {
    var r;
    if ('%AsyncFunction%' === t) r = Si('async function () {}');
    else if ('%GeneratorFunction%' === t) r = Si('function* () {}');
    else if ('%AsyncGeneratorFunction%' === t) r = Si('async function* () {}');
    else if ('%AsyncGenerator%' === t) {
      var n = e('%AsyncGeneratorFunction%');
      n && (r = n.prototype);
    } else if ('%AsyncIteratorPrototype%' === t) {
      var i = e('%AsyncGenerator%');
      i && Ui && (r = Ui(i.prototype));
    }
    return (Fi[t] = r), r;
  },
  Li = {
  ...
  ji = bi,
  Ni = Ai,
  Mi = ji.call(Function.call, Array.prototype.concat),
  Bi = ji.call(Function.apply, Array.prototype.splice),
  Yi = ji.call(Function.call, String.prototype.replace),
  Wi = ji.call(Function.call, String.prototype.slice),
  qi = ji.call(Function.call, RegExp.prototype.exec),
  zi = /[^%.[\]]+|\[(?:(-?\d+(?:\.\d+)?)|(["'])((?:(?!\2)[^\\]|\\.)*?)\2)\]|(?=(?:\.|\[\])(?:\.|\[\]|%$))/g,
  Vi = /\\(\\)?/g,
  Gi = function(e) {
    var t = Wi(e, 0, 1),
    ...
    var n = [];
    return (
      Yi(e, zi, function(e, t, r, i) {
        n[n.length] = r ? Yi(i, Vi, '$1') : t || e;
      }),
      n
    );
  },
  Ki = function(e, t) {
    var r,
      n = e;
    if ((Ni(Li, n) && (n = '%' + (r = Li[n])[0] + '%'), Ni(Fi, n))) {
      var i = Fi[n];
      if ((i === Ci && (i = Di(n)), void 0 === i && !t))
        throw new Oi(
          'intrinsic ' +
            e +
    ...
    throw new wi('intrinsic ' + e + ' does not exist!');
  },
  Hi = function(e, t) {
    if ('string' != typeof e || 0 === e.length)
      throw new Oi('intrinsic name must be a non-empty string');
    if (arguments.length > 1 && 'boolean' != typeof t)
      throw new Oi('"allowMissing" argument must be a boolean');
    if (null === qi(/^%?[^%]*%?$/, e))
      throw new wi(
...
!(function(e) {
  ...
  e.exports = function(e) {
    ...
    if (a && c) {
      var n = a(r, 'length');
      n.configurable &&
        c(r, 'length', { value: 1 + s(0, e.length - (arguments.length - 1)) });
    }
    return r;
  };
  var u = function() {
...
var Ji = Hi,
  Xi = Zi.exports,
  $i = Xi(Ji('String.prototype.indexOf')),
  Qi = function(e, t) {
    var r = Ji(e, !!t);
    return 'function' == typeof r && $i(e, '.prototype.') > -1 ? Xi(r) : r;
  },
  eo = li(),
  to = Qi('Object.prototype.toString'),
  ro = function(e) {
    return (
      !(eo && e && 'object' == typeof e && Symbol.toStringTag in e) &&
      '[object Arguments]' === to(e)
    );
  },
  no = function(e) {
    return (
      ...
      (null !== e &&
        ...
        e.length >= 0 &&
        '[object Array]' !== to(e) &&
        '[object Function]' === to(e.callee))
    );
  },
  io = (function() {
    return ro(arguments);
  })();
ro.isLegacyArguments = no;
var oo,
  ao,
  co,
  so = io ? ro : no,
  ...
  go = function(e) {
    ...
    if (fo.test(lo.call(e))) return !0;
    if (!ho) return '[object GeneratorFunction]' === uo.call(e);
    if (!mo) return !1;
    if (void 0 === oo) {
      var t = (function() {
        if (!ho) return !1;
  ...
  yo = 'object' == typeof Reflect && null !== Reflect && Reflect.apply;
if ('function' == typeof yo && 'function' == typeof Object.defineProperty)
  try {
    (ao = Object.defineProperty({}, 'length', {
      get: function() {
        throw co;
      }
    })),
...
var vo = /^\s*class\b/,
  ...
  Ao = function(e) {
    try {
      return !bo(e) && (po.call(e), !0);
    } catch (e) {
      return !1;
    }
  },
  wo = Object.prototype.toString,
  _o = 'function' == typeof Symbol && !!Symbol.toStringTag,
  Oo = !(0 in [,]),
  So = function() {
    return !1;
  };
if ('object' == typeof document) {
  var Eo = document.all;
  wo.call(Eo) === wo.call(document.all) &&
    (So = function(e) {
      if ((Oo || !e) && (void 0 === e || 'object' == typeof e))
        try {
          var t = wo.call(e);
          return (
...
var To = yo
  ...
  Ro = function(e, t, r) {
    for (var n = 0, i = e.length; n < i; n++)
      ko.call(e, n) && (null == r ? t(e[n], n, e) : t.call(r, e[n], n, e));
  },
  Uo = function(e, t, r) {
    for (var n = 0, i = e.length; n < i; n++)
  ...
  Po = function(e, t, r) {
    if (!To(t)) throw new TypeError('iterator must be a function');
    var n;
    arguments.length >= 3 && (n = r),
      '[object Array]' === xo.call(e)
        ? Ro(e, t, n)
        : 'string' == typeof e
        ? Uo(e, t, n)
        : Co(e, t, n);
  ...
  Io = 'undefined' == typeof globalThis ? le : globalThis,
  Do = function() {
    for (var e = [], t = 0; t < Fo.length; t++)
      'function' == typeof Io[Fo[t]] && (e[e.length] = Fo[t]);
    return e;
  },
  Lo = Hi('%Object.getOwnPropertyDescriptor%', !0);
if (Lo)
  try {
    Lo([], 'length');
  } catch (e) {
...
var jo = Lo,
  ...
  Mo = Do,
  Bo = Qi,
  Yo = Bo('Object.prototype.toString'),
  Wo = li(),
  qo = jo,
  zo = 'undefined' == typeof globalThis ? le : globalThis,
  Vo = Mo(),
  Go =
    Bo('Array.prototype.indexOf', !0) ||
    function(e, t) {
      for (var r = 0; r < e.length; r += 1) if (e[r] === t) return r;
      return -1;
    },
  Ko = Bo('String.prototype.slice'),
  Ho = {},
...
Wo &&
  ...
  No(Vo, function(e) {
    ...
    if (Symbol.toStringTag in t) {
      var r = Zo(t),
        n = qo(r, Symbol.toStringTag);
      if (!n) {
        var i = Zo(r);
        n = qo(i, Symbol.toStringTag);
      }
      Ho[e] = n.get;
    }
  });
var Jo = function(e) {
  ...
  Qo = Qi,
  ea = jo,
  ta = Qo('Object.prototype.toString'),
  ra = li(),
  na = 'undefined' == typeof globalThis ? le : globalThis,
  ia = $o(),
  oa = Qo('String.prototype.slice'),
  aa = {},
...
ra &&
  ...
  ca &&
  Xo(ia, function(e) {
    if ('function' == typeof na[e]) {
      var t = new na[e]();
      if (Symbol.toStringTag in t) {
        var r = ca(t),
          n = ea(r, Symbol.toStringTag);
        if (!n) {
          var i = ca(r);
          n = ea(i, Symbol.toStringTag);
        }
        aa[e] = n.get;
      }
    }
...
!(function(e) {
  ...
  function _(e) {
    return (
      ...
      (w.working ? w(e) : e instanceof DataView)
    );
  }
  (e.isArgumentsObject = t),
    ...
    (e.isWeakMap = function(e) {
      return (
        ...
        (y.working ? y(e) : e instanceof WeakMap)
      );
    }),
  ...
  function E(e) {
    return (
      void 0 !== O &&
      (void 0 === S.working && (S.working = S(new O())),
      S.working ? S(e) : e instanceof O)
    );
  }
  function T(e) {
    return m(e, u);
...
!(function(e) {
  ...
  (e.format = function(e) {
    ...
    for (
      var i = arguments,
        o = i.length,
        c = String(e).replace(r, function(e) {
          if ('%%' === e) return '%';
          if (n >= o) return e;
          switch (e) {
            case '%s':
    ...
    (e.deprecate = function(t, r) {
      if (void 0 !== Ne && !0 === Ne.noDeprecation) return t;
      if (void 0 === Ne)
        return function() {
  ...
  function u(t, r, n) {
    ...
    if (
      ...
      w(r) && (a.indexOf('message') >= 0 || a.indexOf('description') >= 0))
    )
      return l(r);
    if (0 === a.length) {
      if (_(r)) {
    ...
    return (
      ...
      A(r) && (O = ' ' + Date.prototype.toUTCString.call(r)),
      w(r) && (O = ' ' + l(r)),
    ...
    if (
      ...
      c ||
        (e.seen.indexOf(s.value) < 0
          ? (c = m(r) ? u(e, s.value, null) : u(e, s.value, r - 1)).indexOf(
              '\n'
            ) > -1 &&
            (c = o
              ? c
  ...
  (e.promisify = function(e) {
    ...
    (e.callbackify = function(e) {
      ...
      function r() {
        ...
        e.apply(this, t).then(
          function(e) {
            Ne.nextTick(o.bind(null, null, e));
          },
          function(e) {
            Ne.nextTick(R.bind(null, e, o));
          }
        );
      }
      return (
...
function _a(e, t) {
  return !t || ('object' !== Ra(t) && 'function' != typeof t) ? Oa(e) : t;
}
function Oa(e) {
  if (void 0 === e)
    throw new ReferenceError(
...
function Sa(e) {
  ...
  return (
    (Sa = function(e) {
      ...
      function n() {
        return Ta(e, arguments, ka(this).constructor);
      }
      return (
...
va('ERR_AMBIGUOUS_ARGUMENT', 'The "%s" argument is ambiguous. %s', TypeError),
  va(
    'ERR_INVALID_ARG_TYPE',
    function(e, t, r) {
      var n, i, o, a;
      if (
        (void 0 === ga && (ga = ii.exports),
        ga('string' == typeof e, "'name' must be a string"),
        'string' == typeof t &&
        ((i = 'not '), t.substr(!o || o < 0 ? 0 : +o, i.length) === i)
          ? ((n = 'must not be'), (t = t.replace(/^not /, '')))
          : (n = 'must be'),
      ...
      return (a += '. Received type '.concat(fa(r)));
    },
    TypeError
  ),
  va(
  ...
  va(
    ...
    function() {
      for (var e = arguments.length, t = new Array(e), r = 0; r < e; r++)
        t[r] = arguments[r];
      void 0 === ga && (ga = ii.exports),
        ga(t.length > 0, 'At least one arg needs to be specified');
      var n = 'The ',
        i = t.length;
      switch (
        ((t = t.map(function(e) {
  ...
  (oi.codes = ya);
var Ua = ai.inspect,
  Ca = oi.codes.ERR_INVALID_ARG_TYPE;
function Pa(e, t, r) {
  return (
    (void 0 === r || r > e.length) && (r = e.length),
    e.substring(r - t.length, r) === t
...
function La(e, t, r) {
  ...
  for (
    var m = u[u.length - 1], g = l[l.length - 1];
    m === g &&
    (f++ < 2 ? (a = '\n  '.concat(m).concat(a)) : (n = m),
    u.pop(),
    l.pop(),
    0 !== u.length && 0 !== l.length);

  )
    (m = u[u.length - 1]), (g = l[l.length - 1]);
  var p = Math.max(u.length, l.length);
  if (0 === p) {
    var y = s.split('\n');
    if (y.length > 30)
      for (y[26] = ''.concat('', '...').concat(''); y.length > 27; ) y.pop();
    return ''.concat(Fa.notIdentical, '\n\n').concat(y.join('\n'), '\n');
  }
  f > 3 &&
    ((a = '\n'
      .concat('', '...')
  ...
  for (f = 0; f < p; f++) {
    ...
    if (u.length < f + 1)
      ...
      var _ = l[f],
        O = u[f],
        S = O !== _ && (!Pa(O, ',') || O.slice(0, -1) !== _);
      S && Pa(_, ',') && _.slice(0, -1) === O && ((S = !1), (O += ',')),
        S
          ? (w > 1 &&
              f > 2 &&
              (w > 4
...
var ja = (function(e) {
    function t(e) {
      ...
      if (((Error.stackTraceLimit = 0), null != n))
        r = _a(this, ka(t).call(this, String(n)));
      else if (
        ('object' === Ra(a) &&
          null !== a &&
          'object' === Ra(c) &&
        ...
        r = _a(this, ka(t).call(this, La(a, c, i)));
        ...
        if (
          ('notStrictEqual' === i &&
            'object' === Ra(a) &&
            null !== a &&
            (u = Fa.notStrictEqualObject),
          l.length > 30)
        )
          for (l[26] = ''.concat('', '...').concat(''); l.length > 27; )
            l.pop();
        r =
          1 === l.length
            ? _a(this, ka(t).call(this, ''.concat(u, ' ').concat(l[0])))
            : _a(
                this,
                ka(t).call(
                  this,
        ...
        'notDeepEqual' === i || 'notEqual' === i
          ? (f = ''.concat(Fa[i], '\n\n').concat(f)).length > 1024 &&
            (f = ''.concat(f.slice(0, 1021), '...'))
          : ((h = ''.concat(Da(c))),
            ...
            'deepEqual' === i || 'equal' === i
              ? (f = ''.concat(d, '\n\n').concat(f, '\n\nshould equal\n\n'))
              : (h = ' '.concat(i, ' ').concat(h))),
          (r = _a(this, ka(t).call(this, ''.concat(f).concat(h))));
      }
      return (
        (Error.stackTraceLimit = s),
        (r.generatedMessage = !n),
        Object.defineProperty(Oa(r), 'name', {
        ...
        (r.expected = c),
        (r.operator = i),
        Error.captureStackTrace && Error.captureStackTrace(Oa(r), o),
        r.stack,
    ...
    return (
      r ||
        (r =
          ...
          'number' == typeof e.length &&
          e.length >= 0 &&
          '[object Function]' === Wa.call(e.callee)),
      r
    );
  };
if (!Object.keys) {
  var za = Object.prototype.hasOwnProperty,
    ...
    Ha = !Ka.call({ toString: null }, 'toString'),
    Za = Ka.call(function() {}, 'prototype'),
    Ja = [
      'toString',
      'toLocaleString',
      'valueOf',
  ...
  Ba = function(e) {
    var t = null !== e && 'object' == typeof e,
      r = '[object Function]' === Va.call(e),
      n = Ga(e),
      i = t && '[object String]' === Va.call(e),
      o = [];
    if (!t && !r && !n)
      throw new TypeError('Object.keys called on a non-object');
    var a = Za && r;
    if (i && e.length > 0 && !za.call(e, 0))
      for (var c = 0; c < e.length; ++c) o.push(String(c));
    if (n && e.length > 0) for (var s = 0; s < e.length; ++s) o.push(String(s));
    else
      for (var u in e)
        (a && 'prototype' === u) || !za.call(e, u) || o.push(String(u));
    if (Ha)
      for (
        var l = (function(e) {
            if ('undefined' == typeof window || !Qa) return Xa(e);
            try {
              return Xa(e);
            } catch (e) {
              return !1;
        ...
        (l && 'constructor' === Ja[f]) || !za.call(e, Ja[f]) || o.push(Ja[f]);
    return o;
  };
}
var ec = Ba,
  ...
  if (Object.keys) {
    ...
    e ||
      (Object.keys = function(e) {
        return rc(e) ? oc(tc.call(e)) : oc(e);
      });
  } else Object.keys = ic;
  return Object.keys || ic;
};
var ac = ic,
  cc = Hi('%Object.defineProperty%', !0),
  sc = function() {
    if (cc)
      try {
        return cc({}, 'a', { value: 1 }), !0;
      } catch (e) {
        return !1;
      }
    return !1;
  };
sc.hasArrayLengthDefineBug = function() {
  if (!sc()) return null;
  try {
    return 1 !== cc([], 'length', { value: 1 }).length;
  } catch (e) {
    return !0;
  }
};
var uc = sc,
  lc = ac,
  fc = 'function' == typeof Symbol && 'symbol' == typeof Symbol('foo'),
  ...
  yc = function(e, t, r, n) {
    if (t in e)
      if (!0 === n) {
        ...
        'function' != typeof (i = n) ||
        '[object Function]' !== hc.call(i) ||
        !n()
      )
        return;
    var i;
    pc
      ? mc(e, t, { configurable: !0, enumerable: !1, value: r, writable: !0 })
      : (e[t] = r);
  },
  vc = function(e, t) {
    var r = arguments.length > 2 ? arguments[2] : {},
      n = lc(t);
    fc && (n = dc.call(n, Object.getOwnPropertySymbols(t)));
    for (var i = 0; i < n.length; i += 1) yc(e, n[i], t[n[i]], r[n[i]]);
  };
vc.supportsDescriptors = !!pc;
var bc = vc,
  Ac = function(e) {
    return e != e;
  },
  ...
  _c = wc,
  Oc = function() {
    return 'function' == typeof Object.is ? Object.is : _c;
  },
  Sc = Oc,
  Ec = bc,
  Tc = bc,
  ...
  Uc = (0, Zi.exports)(kc(), Object);
Tc(Uc, { getPolyfill: kc, implementation: xc, shim: Rc });
var Cc = Uc,
  Pc = function(e) {
    return e != e;
  },
  ...
  Yc = (0, Zi.exports)(Mc(), Number);
jc(Yc, { getPolyfill: Mc, implementation: Nc, shim: Bc });
var Wc = Yc;
function qc(e, t) {
  return (
    (function(e) {
...
var Vc = void 0 !== /a/g.flags,
  ...
  Hc = Object.is ? Object.is : Cc,
  Zc = Object.getOwnPropertySymbols
    ? Object.getOwnPropertySymbols
    : function() {
        return [];
      },
  Jc = Number.isNaN ? Number.isNaN : Wc;
function Xc(e) {
  return e.call.bind(e);
}
var $c = Xc(Object.prototype.hasOwnProperty),
  Qc = Xc(Object.prototype.propertyIsEnumerable),
  es = Xc(Object.prototype.toString),
  ts = ai.types,
  rs = ts.isAnyArrayBuffer,
  ns = ts.isArrayBufferView,
  is = ts.isDate,
  os = ts.isMap,
  as = ts.isRegExp,
  cs = ts.isSet,
  ss = ts.isNativeError,
  us = ts.isBoxedPrimitive,
  ls = ts.isNumberObject,
  fs = ts.isStringObject,
  hs = ts.isBooleanObject,
  ds = ts.isBigIntObject,
  ms = ts.isSymbolObject,
  gs = ts.isFloat32Array,
  ps = ts.isFloat64Array;
function ys(e) {
...
function vs(e) {
  return Object.keys(e)
    .filter(ys)
    .concat(Zc(e).filter(Object.prototype.propertyIsEnumerable.bind(e)));
}
/*!
 * The buffer module from node.js, for the browser.
 *
...
function As(e, t, r, n) {
  if (e === t) return 0 !== e || !r || Hc(e, t);
  if (r) {
    if ('object' !== zc(e)) return 'number' == typeof e && Jc(e) && Jc(t);
    if ('object' !== zc(t) || null === e || null === t) return !1;
    if (Object.getPrototypeOf(e) !== Object.getPrototypeOf(t)) return !1;
  } else {
    if (null === e || 'object' !== zc(e))
      return (null === t || 'object' !== zc(t)) && e == t;
    if (null === t || 'object' !== zc(t)) return !1;
  }
  var i,
    o,
    a,
  ...
  if (Array.isArray(e)) {
    ...
    var u = vs(e),
      l = vs(t);
    return u.length === l.length && _s(e, t, r, n, 1, u);
  }
  if ('[object Object]' === s && ((!os(e) && os(t)) || (!cs(e) && cs(t))))
    return !1;
  if (is(e)) {
    if (
      !is(t) ||
    ...
    if (
      ...
      (c = t),
      !(Vc
        ? a.source === c.source && a.flags === c.flags
    ...
    if (ns(e)) {
      ...
      var f = vs(e),
        h = vs(t);
      return f.length === h.length && _s(e, t, r, n, 0, f);
    }
    if (cs(e)) return !(!cs(t) || e.size !== t.size) && _s(e, t, r, n, 2);
    if (os(e)) return !(!os(t) || e.size !== t.size) && _s(e, t, r, n, 3);
    if (rs(e)) {
      if (
        ((o = t),
        (i = e).byteLength !== o.byteLength ||
          0 !== bs(new Uint8Array(i), new Uint8Array(o)))
      )
        return !1;
    } else if (
      us(e) &&
...
function _s(e, t, r, n, i, o) {
  ...
  for (var c = 0; c < o.length; c++) if (!$c(t, o[c])) return !1;
    ...
    if (0 !== s.length) {
      ...
      for (c = 0; c < s.length; c++) {
        ...
        if (Qc(e, l)) {
          if (!Qc(t, l)) return !1;
          o.push(l), u++;
        } else if (Qc(t, l)) return !1;
      }
      var f = Zc(t);
      if (s.length !== f.length && ws(t, f).length !== u) return !1;
    } else {
      var h = Zc(t);
      if (0 !== h.length && 0 !== ws(t, h).length) return !1;
    }
  }
  if (
    0 === o.length &&
    (0 === i || (1 === i && 0 === e.length) || 0 === e.size)
  )
    return !0;
  ...
  var g = ks(e, t, r, o, n, i);
  return n.val1.delete(e), n.val2.delete(t), g;
}
function Os(e, t, r, n) {
  for (var i = Gc(e), o = 0; o < i.length; o++) {
    var a = i[o];
...
function Ts(e, t, r, n, i) {
  ...
  var a = t.get(o);
  return (
    !((void 0 === a && !t.has(o)) || !As(n, a, !1, i)) &&
    !e.has(o) &&
    As(n, a, !1, i)
  );
}
function xs(e, t, r, n, i, o) {
  for (var a = Gc(e), c = 0; c < a.length; c++) {
    var s = a[c];
...
function ks(e, t, r, n, i, o) {
  ...
  if (2 === o) {
    if (
      !(function(e, t, r, n) {
        for (var i = null, o = Gc(e), a = 0; a < o.length; a++) {
          var c = o[a];
          if ('object' === zc(c) && null !== c)
            null === i && (i = new Set()), i.add(c);
          else if (!t.has(c)) {
            if (r) return !1;
            if (!Es(e, t, c)) return !1;
            null === i && (i = new Set()), i.add(c);
          }
        }
        if (null !== i) {
          for (var s = Gc(t), u = 0; u < s.length; u++) {
            var l = s[u];
            if ('object' === zc(l) && null !== l) {
              if (!Os(i, l, r, n)) return !1;
            } else if (!r && !e.has(l) && !Os(i, l, r, n)) return !1;
          }
          return 0 === i.size;
        }
        return !0;
    ...
    if (
      !(function(e, t, r, n) {
        for (var i = null, o = Kc(e), a = 0; a < o.length; a++) {
          var c = qc(o[a], 2),
            s = c[0],
            u = c[1];
          if ('object' === zc(s) && null !== s)
            null === i && (i = new Set()), i.add(s);
          else {
            var l = t.get(s);
            if ((void 0 === l && !t.has(s)) || !As(u, l, r, n)) {
              if (r) return !1;
              if (!Ts(e, t, s, u, n)) return !1;
              null === i && (i = new Set()), i.add(s);
            }
          }
        }
        if (null !== i) {
          for (var f = Kc(t), h = 0; h < f.length; h++) {
            var d = qc(f[h], 2),
              m = ((s = d[0]), d[1]);
            if ('object' === zc(s) && null !== s) {
              if (!xs(i, e, s, m, r, n)) return !1;
            } else if (
              !(
                r ||
                (e.has(s) && As(e.get(s), m, !1, n)) ||
                xs(i, e, s, m, !1, n)
              )
            )
              return !1;
    ...
    for (; a < e.length; a++) {
      if (!$c(e, a)) {
        ...
        for (var c = Object.keys(e); a < c.length; a++) {
          var s = c[a];
          if (!$c(t, s) || !As(e[s], t[s], r, i)) return !1;
        }
        return c.length === Object.keys(t).length;
      }
      if (!$c(t, a) || !As(e[a], t[a], r, i)) return !1;
    }
...
var Cs,
  Ps,
  Fs = oi.codes,
  Is = Fs.ERR_AMBIGUOUS_ARGUMENT,
  Ds = Fs.ERR_INVALID_ARG_TYPE,
  Ls = Fs.ERR_INVALID_ARG_VALUE,
  js = Fs.ERR_INVALID_RETURN_VALUE,
  Ns = Fs.ERR_MISSING_ARGS,
  Ms = Na,
  Bs = ai.inspect,
  Ys = ai.types,
  Ws = Ys.isPromise,
  qs = Ys.isRegExp,
  zs = Object.assign ? Object.assign : Ya.assign,
  Vs = Object.is ? Object.is : Cc;
function Gs() {
  (Cs = Rs.isDeepEqual), (Ps = Rs.isDeepStrictEqual);
}
var Ks = !1,
  Hs = (ii.exports = $s),
  Zs = {};
...
function $s() {
  for (var e = arguments.length, t = new Array(e), r = 0; r < e; r++)
    t[r] = arguments[r];
  Xs.apply(void 0, [$s, t.length].concat(t));
}
(Hs.fail = function e(t, r, n, i, o) {
  var a,
    c = arguments.length;
  if (0 === c) a = 'Failed';
  ...
  (Hs.AssertionError = Ms),
  (Hs.ok = $s),
  (Hs.equal = function e(t, r, n) {
    if (arguments.length < 2) throw new Ns('actual', 'expected');
    t != r &&
      Js({
        actual: t,
        expected: r,
  ...
  (Hs.notDeepEqual = function e(t, r, n) {
    if (arguments.length < 2) throw new Ns('actual', 'expected');
    void 0 === Cs && Gs(),
      Cs(t, r) &&
        Js({
  ...
  (Hs.deepStrictEqual = function e(t, r, n) {
    if (arguments.length < 2) throw new Ns('actual', 'expected');
    void 0 === Cs && Gs(),
      Ps(t, r) ||
        Js({
  ...
  (Hs.notDeepStrictEqual = function e(t, r, n) {
    if (arguments.length < 2) throw new Ns('actual', 'expected');
    void 0 === Cs && Gs();
    Ps(t, r) &&
      Js({
  ...
  (Hs.strictEqual = function e(t, r, n) {
    if (arguments.length < 2) throw new Ns('actual', 'expected');
    Vs(t, r) ||
      Js({
        actual: t,
  ...
  (Hs.notStrictEqual = function e(t, r, n) {
    if (arguments.length < 2) throw new Ns('actual', 'expected');
    Vs(t, r) &&
      Js({
        actual: t,
...
var Qs = function e(t, r, n) {
  ...
  !(function(e, t) {
    ...
    r.forEach(function(e) {
      e in t &&
        (void 0 !== n && 'string' == typeof n[e] && qs(t[e]) && t[e].test(n[e])
          ? (i[e] = n[e])
          : (i[e] = t[e]));
    });
};
function eu(e, t, r, n, i, o) {
  if (!(r in e) || !Ps(e[r], t[r])) {
    if (!n) {
      var a = new Qs(e, i),
        c = new Qs(t, i, e),
        s = new Ms({
...
function tu(e, t, r, n) {
  if ('function' != typeof t) {
    if (qs(t)) return t.test(e);
    if (2 === arguments.length)
      throw new Ds('expected', ['Function', 'RegExp'], t);
    ...
    if (t instanceof Error) o.push('name', 'message');
      ...
      throw new Ls('error', t, 'may not be an empty object');
    return (
      void 0 === Cs && Gs(),
      o.forEach(function(i) {
        ('string' == typeof e[i] && qs(t[i]) && t[i].test(e[i])) ||
          eu(e, t, i, r, o, n);
      }),
      !0
    );
...
function ru(e) {
  if ('function' != typeof e) throw new Ds('fn', 'Function', e);
  try {
    e();
  } catch (e) {
    return e;
...
function iu(e) {
  return Promise.resolve().then(function() {
    var t;
    if ('function' == typeof e) {
      if (!nu((t = e()))) throw new js('instance of Promise', 'promiseFn', t);
    } else {
      if (!nu(e)) throw new Ds('promiseFn', ['Function', 'Promise'], e);
      t = e;
    }
...
function ou(e, t, r, n) {
  if ('string' == typeof r) {
    if (4 === arguments.length)
      throw new Ds('error', ['Object', 'Error', 'Function', 'RegExp'], r);
    if ('object' === Us(t) && null !== t) {
      if (t.message === r)
        throw new Is(
          'error/message',
    ...
    (n = r), (r = void 0);
  } else if (null != r && 'object' !== Us(r) && 'function' != typeof r)
    throw new Ds('error', ['Object', 'Error', 'Function', 'RegExp'], r);
  if (t === Zs) {
    var i = '';
  ...
  if (r && !tu(t, r, n, e)) throw t;
}
function au(e, t, r, n) {
  if (t !== Zs) {
    if (('string' == typeof r && ((n = r), (r = void 0)), !r || tu(t, r))) {
      var i = n ? ': '.concat(n) : '.',
...
function cu() {
  for (var e = arguments.length, t = new Array(e), r = 0; r < e; r++)
    t[r] = arguments[r];
  Xs.apply(void 0, [cu, t.length].concat(t));
}
(Hs.throws = function e(t) {
  for (
    ...
    n[i - 1] = arguments[i];
  ou.apply(void 0, [e, ru(t)].concat(n));
}),
  (Hs.rejects = function e(t) {
    for (
      var r = arguments.length, n = new Array(r > 1 ? r - 1 : 0), i = 1;
      i < r;
      i++
    ...
    return iu(t).then(function(t) {
      return ou.apply(void 0, [e, t].concat(n));
    });
  }),
  (Hs.doesNotThrow = function e(t) {
    for (
      var r = arguments.length, n = new Array(r > 1 ? r - 1 : 0), i = 1;
      i < r;
      i++
      ...
      n[i - 1] = arguments[i];
    au.apply(void 0, [e, ru(t)].concat(n));
  }),
  (Hs.doesNotReject = function e(t) {
    for (
      var r = arguments.length, n = new Array(r > 1 ? r - 1 : 0), i = 1;
      i < r;
      i++
      ...
      n[i - 1] = arguments[i];
    return iu(t).then(function(t) {
      return au.apply(void 0, [e, t].concat(n));
    });
  }),
  (Hs.ifError = function e(t) {
    if (null != t) {
      var r = 'ifError got unwanted exception: ';
      'object' === Us(t) && 'string' == typeof t.message
  ...
  (Hs.strict = zs(cu, Hs, {
    equal: Hs.strictEqual,
    deepEqual: Hs.deepStrictEqual,
    notEqual: Hs.notStrictEqual,
    notDeepEqual: Hs.notDeepStrictEqual
  })),
  (Hs.strict.strict = Hs.strict),
  (function(e) {
    var t = ii.exports,
      a = r,
      c = n,
    ...
    (f.prototype.close = function() {
      ...
      (f.prototype._write = function(r, n, i, o, a, c, s, u) {
        if (
          ...
          t.equal(!1, this.write_in_progress, 'write already in progress'),
          t.equal(!1, this.pending_close, 'close is pending'),
          (this.write_in_progress = !0),
          t.equal(!1, void 0 === n, 'must provide flush value'),
          (this.write_in_progress = !0),
          n !== e.Z_NO_FLUSH &&
            n !== e.Z_PARTIAL_FLUSH &&
            n !== e.Z_SYNC_FLUSH &&
        ...
        if (
          (null == i && ((i = x.alloc(0)), (a = 0), (o = 0)),
          (this.strm.avail_in = a),
          (this.strm.input = i),
          (this.strm.next_in = o),
          ...
          case e.UNZIP:
            switch (
              ...
              case 0:
                ...
                if (
                  ((this.gzip_id_bytes_read = 1), t++, 1 === this.strm.avail_in)
                )
                  break;
              case 1:
                if (null === t) break;
        ...
        t(
          ...
          t(
            o === e.Z_FILTERED ||
              ...
              o === e.Z_RLE ||
              o === e.Z_FIXED ||
              o === e.Z_DEFAULT_STRATEGY,
            'invalid strategy'
          ),
          this._init(n, r, i, o, a),
          this._setDictionary();
      }),
      ...
      (f.prototype._init = function(t, r, n, i, o) {
        switch (
          ((this.level = t),
          (this.windowBits = r),
          (this.memLevel = n),
  ...
  (function(e) {
    ...
    function g(e, r, n) {
      ...
      function u() {
        var r,
          s = null;
        o >= a ? (s = new RangeError(c)) : (r = t.concat(i, o)),
          (i = []),
          e.close(),
          n(s, r);
      }
    ...
    function p(e, r) {
      if (('string' == typeof r && (r = t.from(r)), !t.isBuffer(r)))
    ...
    function E(i, o) {
      ...
      if (
        ...
        (this._finishFlushFlag =
          void 0 !== i.finishFlush ? i.finishFlush : n.Z_FINISH),
        i.chunkSize &&
          (i.chunkSize < e.Z_MIN_CHUNK || i.chunkSize > e.Z_MAX_CHUNK))
      )
        throw new Error('Invalid chunk size: ' + i.chunkSize);
      if (
        i.windowBits &&
        (i.windowBits < e.Z_MIN_WINDOWBITS || i.windowBits > e.Z_MAX_WINDOWBITS)
      )
        throw new Error('Invalid windowBits: ' + i.windowBits);
      if (i.level && (i.level < e.Z_MIN_LEVEL || i.level > e.Z_MAX_LEVEL))
        throw new Error('Invalid compression level: ' + i.level);
      if (
        i.memLevel &&
        (i.memLevel < e.Z_MIN_MEMLEVEL || i.memLevel > e.Z_MAX_MEMLEVEL)
      )
        throw new Error('Invalid memLevel: ' + i.memLevel);
      if (
        i.strategy &&
        i.strategy != e.Z_FILTERED &&
        i.strategy != e.Z_HUFFMAN_ONLY &&
        i.strategy != e.Z_RLE &&
        i.strategy != e.Z_FIXED &&
        i.strategy != e.Z_DEFAULT_STRATEGY
      )
        throw new Error('Invalid strategy: ' + i.strategy);
      if (i.dictionary && !t.isBuffer(i.dictionary))
      ...
      'number' == typeof i.strategy && (u = i.strategy),
        this._handle.init(
          i.windowBits || e.Z_DEFAULT_WINDOWBITS,
          s,
          i.memLevel || e.Z_DEFAULT_MEMLEVEL,
          u,
          i.dictionary
        ),
    ...
    function T(e, t) {
      t && Ne.nextTick(t), e._handle && (e._handle.close(), (e._handle = null));
    }
    function x(e) {
      e.emit('close');
    }
      ...
      (E.prototype.params = function(t, r, i) {
        ...
        if (this._level !== t || this._strategy !== r) {
          ...
          this.flush(n.Z_SYNC_FLUSH, function() {
            o(a._handle, 'zlib binding closed'),
              a._handle.params(t, r),
              a._hadError || ((a._level = t), (a._strategy = r), i && i());
          });
        } else Ne.nextTick(i);
      }),
        ...
        return null === e || t.isBuffer(e)
          ? this._handle
            ? (c
              ...
              void this._processChunk(e, o, i))
            : i(new Error('zlib binding closed'))
...
var su,
  ...
  mu = (function(r) {
    function n(e, n, i) {
      ...
      return (
        ((o =
          r.call(this, { decodeStrings: !1 }) ||
          this).finalize = o.finalize.bind(t(o))),
        (o.document = e),
        (o.id = n),
        null == i && (i = {}),
        (o.data = i),
        (o.gen = 0),
        (o.deflate = null),
        (o.compress = o.document.compress && !o.data.Filter),
        (o.uncompressedLength = 0),
        (o.chunks = []),
        o
      );
    }
    ...
    var i = n.prototype;
    return (
      (i.initDeflate = function() {
        var e = this;
        return (
          (this.data.Filter = 'FlateDecode'),
          (this.deflate = ri.createDeflate()),
          this.deflate.on('data', function(t) {
      ...
      (i.end = function() {
        return (
          r.prototype.end.apply(this, arguments),
      ...
      (i.finalize = function() {
        if (
          ...
          this.document._write(Au.convert(this.data)),
          this.chunks.length)
        ) {
  ...
  gu = (function(t) {
    ...
    var n = r.prototype;
    return (
      (n._compareKeys = function(e, t) {
        return e.localeCompare(t);
      }),
      (n._keysName = function() {
        return 'Names';
      }),
      (n._dataForKey = function(e) {
        return new String(e);
      }),
      r
    );
    ...
    (function() {
      function e(e) {
        void 0 === e && (e = {}),
          (this._items = {}),
          (this.limits = 'boolean' != typeof e.limits || e.limits);
      }
      var t = e.prototype;
      return (
        (t.add = function(e, t) {
        ...
        (t.toString = function() {
          ...
          if (this.limits && t.length > 1) {
            ...
            r.push(
              '  /Limits ' +
                Au.convert([this._dataForKey(n), this._dataForKey(i)])
            );
          }
          r.push('  /' + this._keysName() + ' [');
          for (var o, c = a(t); !(o = c()).done; ) {
            var s = o.value;
            r.push(
              '    ' +
                Au.convert(this._dataForKey(s)) +
                ' ' +
                Au.convert(this._items[s])
            );
          }
          ...
          return (
            n &&
              (r = (function(e) {
                ...
                return e;
              })(x.from('\ufeff' + r, 'utf16le')).toString('binary')),
            '(' +
              (r = r.replace(pu, function(e) {
                return yu[e];
              })) +
              ')'
          );
        }
        if (x.isBuffer(t)) return '<' + t.toString('hex') + '>';
        if (t instanceof mu || t instanceof gu) return t.toString();
        if (t instanceof Date)
          return (
            '(D:' +
            vu(t.getUTCFullYear(), 4) +
            vu(t.getUTCMonth() + 1, 2) +
            vu(t.getUTCDate(), 2) +
            vu(t.getUTCHours(), 2) +
            vu(t.getUTCMinutes(), 2) +
            vu(t.getUTCSeconds(), 2) +
            'Z)'
          );
        if (Array.isArray(t))
          return (
  ...
  Ou = (function() {
    function e(e, t) {
      void 0 === t && (t = {}),
        ...
        (this.userUnit = t.userUnit || 1),
        (this.margins = wu);
      var r = Array.isArray(this.size)
        ? this.size
        : _u[this.size.toUpperCase()];
    ...
    return (
      ...
      c(e, [
        ...
        },
        {
          ...
          get: function() {
            var e = this.dictionary.data;
            return null != e.StructParents
              ? e.StructParents
              : (e.StructParents = this.document.createStructParentTreeNextKey());
          }
        }
      ]),
      e
  ...
  Su = (function() {
    function e() {}
    return (
      (e.generateFileID = function(e) {
        void 0 === e && (e = {});
        var t = e.CreationDate.getTime() + '\n';
        for (var r in e)
          e.hasOwnProperty(r) && (t += r + ': ' + e[r].valueOf() + '\n');
        return (function(e) {
          for (var t = [], r = 0; r < e.sigBytes; r++)
            t.push((e.words[Math.floor(r / 4)] >> (8 * (3 - (r % 4)))) & 255);
          return x.from(t);
        })(s(t));
      }),
      e
  ...
  Tu = (function() {
    ...
    var t = e.prototype;
    return (
      (t.stop = function(e, t, r) {
        if (
          (null == r && (r = 1),
          (t = this.doc._normalizeColor(t)),
          0 === this.stops.length)
        )
          ...
          ('DeviceRGB' === this._colorSpace && 3 !== t.length) ||
          ('DeviceCMYK' === this._colorSpace && 4 !== t.length) ||
          ('DeviceGray' === this._colorSpace && 1 !== t.length)
        )
          throw new Error('All gradient stops must use the same color space');
        return (
          (r = Math.max(0, Math.min(1, r))), this.stops.push([e, t, r]), this
        );
      }),
      ...
      (t.embed = function(e) {
        ...
        if (0 !== r) {
          ...
          for (var i = [], o = [], c = [], s = 0; s < r - 1; s++)
            o.push(0, 1),
              s + 2 !== r && i.push(this.stops[s + 1][0]),
              (t = this.doc.ref({
                FunctionType: 2,
                Domain: [0, 1],
                C0: this.stops[s + 0][1],
          ...
          if (
            ...
            var f = this.opacityGradient();
            f._colorSpace = 'DeviceGray';
            for (var h, d = a(this.stops); !(h = d()).done; ) {
              var m = h.value;
              f.stop(m[0], [m[2]]);
            }
            ...
            var y = this.doc.ref({
              Type: 'ExtGState',
              SMask: { Type: 'Mask', S: 'Luminosity', G: p }
            });
            y.end();
            var v = this.doc.ref({
              Type: 'Pattern',
            ...
            v.write('/Gs1 gs /Pattern cs /Sh1 scn'),
              v.end(g.join(' ') + ' re f'),
              (this.doc.page.patterns[this.id] = v);
          } else this.doc.page.patterns[this.id] = l;
          return l;
        }
      }),
      (t.apply = function(e) {
        ...
        return (
          (this.embedded && g.join(' ') === this.matrix.join(' ')) ||
            this.embed(g),
  ...
  xu = (function(t) {
    ...
    return (
      ...
      (n.opacityGradient = function() {
        return new r(this.doc, this.x1, this.y1, this.x2, this.y2);
      }),
      r
    );
  })(Tu),
  ku = (function(t) {
    function r(e, r, n, i, o, a, c) {
      var s;
      return (
        ((s = t.call(this, e) || this).doc = e),
        (s.x1 = r),
        (s.y1 = n),
        (s.r1 = i),
        (s.x2 = o),
  ...
  Ru = { PDFGradient: Tu, PDFLinearGradient: xu, PDFRadialGradient: ku },
  Uu = Ru.PDFGradient,
  Cu = Ru.PDFLinearGradient,
  Pu = Ru.PDFRadialGradient,
  Fu = {
    initColor: function() {
      return (
    ...
    _normalizeColor: function(e) {
      ...
      return Array.isArray(e)
        ? (3 === e.length
            ? (e = (function() {
                for (var r = [], n = 0, i = Array.from(e); n < i.length; n++)
                  (t = i[n]), r.push(t / 255);
                return r;
              })())
            : 4 === e.length &&
    ...
    _setColor: function(e, t) {
      ...
      var r = t ? 'SCN' : 'scn';
      if (e instanceof Uu) this._setColorSpace('Pattern', t), e.apply(r);
      else {
        var n = 4 === e.length ? 'DeviceCMYK' : 'DeviceRGB';
        this._setColorSpace(n, t),
          (e = e.join(' ')),
          this.addContent(e + ' ' + r);
      }
      return !0;
    ...
    fillColor: function(e, t) {
      return (
        this._setColor(e, !1) && this.fillOpacity(t),
        (this._fillColor = [e, t]),
        this
      );
    },
...
var Du = {
  ...
  Mu = function(e, t) {
    for (var r = t, n = '', i = 'none'; r < e.length; r += 1) {
      ...
      if ('.' !== o || ('none' !== i && 'sign' !== i && 'whole' !== i)) {
        if (
          ('E' !== o && 'e' !== o) ||
          ('whole' !== i && 'decimal_point' !== i && 'decimal' !== i)
        )
          break;
        (i = 'e'), (n += o);
  ...
  Bu = {
    ...
    S: function(e, t) {
      return (
        null === lu && ((lu = su), (fu = uu)),
        e.bezierCurveTo(su - (lu - su), uu - (fu - uu), t[0], t[1], t[2], t[3]),
        (lu = t[0]),
        (fu = t[1]),
        (su = t[2]),
        (uu = t[3])
    ...
    Q: function(e, t) {
      return (
        ...
        (su = t[2]),
        (uu = t[3]),
        e.quadraticCurveTo(t[0], t[1], su, uu)
      );
    },
    q: function(e, t) {
      return (
        e.quadraticCurveTo(t[0] + su, t[1] + uu, t[2] + su, t[3] + uu),
        (lu = su + t[0]),
        (fu = uu + t[1]),
        (su += t[2]),
        (uu += t[3])
    ...
    T: function(e, t) {
      return (
        null === lu
          ? ((lu = su), (fu = uu))
          : ((lu = su - (lu - su)), (fu = uu - (fu - uu))),
        e.quadraticCurveTo(lu, fu, t[0], t[1]),
        (lu = su - (lu - su)),
        (fu = uu - (fu - uu)),
        (su = t[0]),
        (uu = t[1])
    ...
    t: function(e, t) {
      return (
        null === lu
          ? ((lu = su), (fu = uu))
          : ((lu = su - (lu - su)), (fu = uu - (fu - uu))),
        e.quadraticCurveTo(lu, fu, su + t[0], uu + t[1]),
        (su += t[0]),
        (uu += t[1])
      );
    },
    A: function(e, t) {
      return Yu(e, su, uu, t), (su = t[5]), (uu = t[6]);
    },
    a: function(e, t) {
      return (
        (t[5] += su), (t[6] += uu), Yu(e, su, uu, t), (su = t[5]), (uu = t[6])
      );
    },
    L: function(e, t) {
      return (su = t[0]), (uu = t[1]), (lu = fu = null), e.lineTo(su, uu);
    },
    l: function(e, t) {
      return (su += t[0]), (uu += t[1]), (lu = fu = null), e.lineTo(su, uu);
    },
    H: function(e, t) {
      return (su = t[0]), (lu = fu = null), e.lineTo(su, uu);
    },
    h: function(e, t) {
      return (su += t[0]), (lu = fu = null), e.lineTo(su, uu);
    },
    V: function(e, t) {
      return (uu = t[0]), (lu = fu = null), e.lineTo(su, uu);
    },
    v: function(e, t) {
      return (uu += t[0]), (lu = fu = null), e.lineTo(su, uu);
    },
    Z: function(e) {
      return e.closePath(), (su = hu), (uu = du);
    },
    z: function(e) {
      return e.closePath(), (su = hu), (uu = du);
    }
  ...
  Wu = function(e, t, r, n, i, o, a, c, s) {
    var u = a * (Math.PI / 180),
      l = Math.sin(u),
      f = Math.cos(u);
    (r = Math.abs(r)), (n = Math.abs(n));
    var h =
      ((lu = f * (c - e) * 0.5 + l * (s - t) * 0.5) * lu) / (r * r) +
      ((fu = f * (s - t) * 0.5 - l * (c - e) * 0.5) * fu) / (n * n);
    ...
    T < 0 && 1 === o
      ...
      : T > 0 && 0 === o && (T -= 2 * Math.PI);
    for (
      var x = Math.ceil(Math.abs(T / (0.5 * Math.PI + 0.001))), k = [], R = 0;
      R < x;
      R++
    ) {
      var U = E + (R * T) / x,
  ...
  zu = (function() {
    ...
    return (
      (e.apply = function(e, t) {
        var r = (function(e) {
          for (
            var t = [], r = null, n = [], i = 0, o = !1, a = !1, c = 0;
            c < e.length;
            c += 1
          ) {
            var s = e.charAt(c);
            if (!ju(s))
              if (o && ',' === s) {
                ...
                (n = []),
                  (o = !1),
                  0 === (i = Du[(r = s)]) && t.push({ command: r, args: n });
              } else {
                if (null == r) return t;
                var u = c,
                  l = null;
  ...
  Ku = {
      ...
      if (Array.isArray(e))
        return (
          (e = Array.from(e)
            ...
            .join(' ')),
          (r = t.phase || 0),
          this.addContent('[' + e + '] ' + Au.number(r) + ' d')
        );
      var n = null != t.space ? t.space : e;
      return (
        (r = t.phase || 0),
        this.addContent(
          '[' + Au.number(e) + ' ' + Au.number(n) + '] ' + Au.number(r) + ' d'
        )
      );
    },
    undash: function() {
    ...
    moveTo: function(e, t) {
      return this.addContent(Vu(e) + ' ' + Vu(t) + ' m');
    },
    lineTo: function(e, t) {
      return this.addContent(Vu(e) + ' ' + Vu(t) + ' l');
    },
    ...
    quadraticCurveTo: function(e, t, r, n) {
      return this.addContent(
        Vu(e) + ' ' + Vu(t) + ' ' + Vu(r) + ' ' + Vu(n) + ' v'
      );
    },
    rect: function(e, t, r, n) {
      return this.addContent(
        Vu(e) + ' ' + Vu(t) + ' ' + Vu(r) + ' ' + Vu(n) + ' re'
      );
    },
    roundedRect: function(e, t, r, n, i) {
      null == i && (i = 0);
      var o = (i = Math.min(i, 0.5 * r, 0.5 * n)) * (1 - Gu);
      return (
        this.moveTo(e + i, t),
        this.lineTo(e + r - i, t),
        this.bezierCurveTo(e + r - o, t, e + r, t + o, e + r, t + i),
        this.lineTo(e + r, t + n - i),
        this.bezierCurveTo(
          e + r,
          t + n - o,
          e + r - o,
        ...
        this.lineTo(e + i, t + n),
        this.bezierCurveTo(e + o, t + n, e, t + n - o, e, t + n - i),
        this.lineTo(e, t + i),
        this.bezierCurveTo(e, t + o, e + o, t, e + i, t),
        this.closePath()
      );
    },
    ellipse: function(e, t, r, n) {
      ...
      return (
        this.moveTo(e, u),
        this.bezierCurveTo(e, u - o, s - i, t, s, t),
        this.bezierCurveTo(s + i, t, a, u - o, a, u),
        this.bezierCurveTo(a, u + o, s + i, c, s, c),
        this.bezierCurveTo(s - i, c, e, u + o, e, u),
        this.closePath()
      );
    },
    ...
    fill: function(e, t) {
      return (
        /(even-?odd)|(non-?zero)/.test(e) && ((t = e), (e = null)),
        e && this.fillColor(e),
        this.addContent('f' + this._windingRule(t))
      );
    },
    stroke: function(e) {
    ...
    fillAndStroke: function(e, t, r) {
      ...
      return (
        n.test(e) && ((r = e), (e = null)),
        n.test(t) && ((r = t), (t = e)),
        e && (this.fillColor(e), this.strokeColor(t)),
...
var Ju = (function() {
    function e(e) {
      ...
      'string' == typeof e
        ...
        (this.charWidths = (function(e, t, r) {
          for (
            var n = [], i = e < t, o = r ? (i ? t + 1 : t - 1) : t, a = e;
            i ? a < o : a > o;
            i ? a++ : a--
          )
            n.push(a);
    ...
    return (
      (t.parse = function() {
        var e = (function(e) {
          for (
            var t,
              r = { attributes: {}, glyphWidths: {}, kernPairs: {} },
              n = '',
              i = a(e.split('\n'));
            !(t = i()).done;
            ...
            var o,
              c,
              s = t.value;
            if ((o = s.match(/^Start(\w+)/))) n = o[1];
            else if ((o = s.match(/^End(\w+)/))) n = '';
            else
              switch (n) {
                case 'FontMetrics':
                  var u = (o = s.match(/(^\w+)\s+(.*)/))[1],
                    l = o[2];
                  (c = r.attributes[u])
                    ? (Array.isArray(c) || (c = r.attributes[u] = [c]),
                      c.push(l))
                    : (r.attributes[u] = l);
                  break;
                case 'CharMetrics':
                  if (!/^CH?\s/.test(s)) continue;
                  var f = s.match(/\bN\s+(\.?\w+)\s*;/)[1];
                  r.glyphWidths[f] = +s.match(/\bWX\s+(\d+)\s*;/)[1];
                  break;
                case 'KernPairs':
                  (o = s.match(/^KPX\s+(\.?\w+)\s+(\.?\w+)\s+(-?\d+)/)) &&
                    (r.kernPairs[o[1] + o[2]] = parseInt(o[3]));
              }
          }
          return r;
        })(this.contents);
      ...
      (t.encodeText = function(e) {
        for (
          var t = [], r = 0, n = e.length, i = 0 <= n;
          i ? r < n : r > n;
          i ? r++ : r--
        ) {
          var o = e.charCodeAt(r);
          (o = Hu[o] || o), t.push(o.toString(16));
        }
        return t;
      }),
  ...
  Xu = function(e) {
    return [e.FontName, { attributes: e, glyphWidths: {}, kernPairs: {} }];
  },
  $u = (function(e) {
    var t = e.attributes,
      r = e.glyphWidths,
  ...
  el = (function() {
    ...
    e.open = function(e, t, r, n) {
      var i;
      if ('string' == typeof t) {
        if (tl.isStandardFont(t)) return new tl(e, t, n);
  ...
  tl = (function(t) {
    return (function(t) {
      function r(e, r, n) {
        var i;
        return (
          ((i = t.call(this) || this).document = e),
          (i.name = r),
          (i.id = n),
          (i.font = Ju.fromJson($u[i.name])),
      ...
      return (
        ...
        (n.encode = function(e) {
          for (
            var t = this.font.encodeText(e),
              r = this.font.glyphsForString('' + e),
              n = this.font.advancesForGlyphs(r),
              i = [],
              o = 0;
            o < r.length;
            o++
        ...
        (n.widthOfString = function(e, t) {
          for (
            var r = this.font.glyphsForString('' + e),
              n = this.font.advancesForGlyphs(r),
              i = 0,
              o = 0,
              a = Array.from(n);
    ...
    return (function(t) {
      function r(e, r, n) {
        ...
        return (
          ...
          (i.unicode = [[0]]),
          (i.widths = [i.font.getGlyph(0).advanceWidth]),
          (i.name = i.font.postscriptName),
          (i.scale = 1e3 / i.font.unitsPerEm),
      ...
      var n = r.prototype;
      return (
        (n.layoutRun = function(e, t) {
          for (
            var r = this.font.layout(e, t), n = 0;
        ...
        (n.layout = function(e, t, r) {
          ...
          for (
            ...
            if (
              (c === e.length && a < c) ||
              ((s = e.charAt(c)), [' ', '\t'].includes(s))
            ) {
              var u = this.layoutCached(e.slice(a, ++c));
              r ||
                (n.push.apply(n, Array.from(u.glyphs || [])),
                i.push.apply(i, Array.from(u.positions || []))),
                (o += u.advanceWidth),
                (a = c);
            } else c++;
          }
          return { glyphs: n, positions: i, advanceWidth: o };
        }),
        (n.encode = function(e, t) {
          for (
            var r = this.layout(e, t),
              n = r.glyphs,
              i = r.positions,
              o = [],
              a = 0;
            ...
            o.push(('0000' + s.toString(16)).slice(-4)),
              null == this.widths[s] &&
                (this.widths[s] = c.advanceWidth * this.scale),
              null == this.unicode[s] &&
                (this.unicode[s] = this.font._cmapProcessor.codePointsForGlyph(
                  c.id
                ));
          }
          return [o, i];
        ...
        (n.encodeGlyphs = function(e) {
          for (var t = [], r = 0; r < e.length; r++) {
            ...
            t.push(('0000' + i.toString(16)).slice(-4)),
              null == this.widths[i] &&
                (this.widths[i] = n.advanceWidth * this.scale),
              null == this.unicode[i] &&
                (this.unicode[i] = this.font._cmapProcessor.codePointsForGlyph(
                  n.id
                ));
          }
          return t;
        }),
        (n.widthOfString = function(e, t, r) {
        ...
        (n.embed = function() {
          ...
          var r =
              ((null != this.font['OS/2']
                ...
                : void 0) || 0) >> 8,
            n = 0;
          this.font.post.isFixedPitch && (n |= 1),
            1 <= r && r <= 7 && (n |= 2),
            (n |= 4),
            10 === r && (n |= 8),
            this.font.head.macStyle.italic && (n |= 64);
          var i =
              [0, 1, 2, 3, 4, 5]
                .map(function(e) {
        ...
        (n.toUnicodeCmap = function() {
          for (
            var e = this.document.ref(),
              t = [],
              r = 0,
              n = Array.from(this.unicode);
            r < n.length;
            r++
          )
            for (
              var i = n[r], o = [], a = 0, c = Array.from(i);
              a < c.length;
              a++
            ) {
              var s = c[a];
  ...
  nl = {
    ...
    font: function(e, t, r) {
      ...
      if ((null != r && this.fontSize(r), (i = this._fontFamilies[n])))
        return (this._font = i), this;
      var a = 'F' + ++this._fontCount;
      return (
        (this._font = el.open(this, e, t, a)),
        (i = this._fontFamilies[this._font.name])
          ? ((this._font = i), this)
          : (n && (this._fontFamilies[n] = this._font),
            this._font.name &&
    ...
    registerFont: function(e, t, r) {
      return (this._registeredFonts[e] = { src: t, family: r }), this;
    }
  },
  il = Au.number,
  ol = {
    ...
    _text: function(e, t, r, n, i) {
      var o = this;
      (e = null == e ? '' : '' + e),
        (n = this._initOptions(t, r, n)).wordSpacing &&
          (e = e.replace(/\s{2,}/g, ' '));
      for (var c, s = a(e.split('\n')); !(c = s()).done; ) {
        var u = c.value;
        n.structParent &&
          n.structParent.add(
            o.struct(n.structType || 'P', [
              o.markStructureContent(n.structType || 'P')
            ])
          ),
          i(u, n);
      }
    ...
    widthOfString: function(e, t) {
      return (
        void 0 === t && (t = {}),
        this._font.widthOfString(e, this._fontSize, t.features) +
          (t.characterSpacing || 0) * (e.length - 1)
      );
    },
    _initOptions: function(e, t, r) {
      ...
      return (
        ...
        !1 !== n.lineBreak &&
          (null == n.width &&
            (n.width = this.page.width - this.x - this.page.margins.right),
          (n.width = Math.max(n.width, 0))),
    ...
    _line: function(e, t) {
      return (
        void 0 === t && (t = {}),
        this._fragment(e, this.x, this.y, t),
    ...
    _glyphs: function(e, t, r, n, i) {
      ...
      this.save(),
        ...
        (n = this.page.height - n),
        null == this.page.fonts[this._font.id] &&
          (this.page.fonts[this._font.id] = this._font.ref()),
        this.addContent('BT'),
        this.addContent('1 0 0 1 ' + il(r) + ' ' + il(n) + ' Tm'),
        this.addContent('/' + this._font.id + ' ' + il(this._fontSize) + ' Tf');
      ...
      var h = function(r) {
        ...
        d = function(e) {
          if ((h(e), c.length > 0))
            return a.addContent('[' + c.join(' ') + '] TJ'), (c.length = 0);
        };
      for (o = 0; o < t.length; o++) {
        ...
        m.xOffset || m.yOffset
          ...
          : (l &&
              (this.addContent('1 0 0 1 ' + il(r) + ' ' + il(n) + ' Tm'),
              (l = !1)),
            m.xAdvance - m.advanceWidth != 0 && h(o + 1)),
          (r += m.xAdvance * s);
      }
  ...
  cl = (function() {
    function e(e, t) {
      var r;
      if (
        ((this.data = e), (this.label = t), 65496 !== this.data.readUInt16BE(0))
      )
      ...
      for (
        ...
        (n += 2),
        !Array.from(al).includes(r));

      )
        n += this.data.readUInt16BE(n);
      if (!Array.from(al).includes(r)) throw 'Invalid JPEG.';
      (n += 2),
    ...
    return (
      (t.embed = function(e) {
        ...
        if (((this.document = e), !this.obj)) {
          ...
          if (0 === this.image.palette.length)
            ...
            o.end(x.from(this.image.palette)),
          ...
          if (null != this.image.transparency.grayscale) {
            ...
            this.obj.data.Mask = [c, c];
          } else if (this.image.transparency.rgb) {
            for (
              var s, u = this.image.transparency.rgb, l = [], f = a(u);
              !(s = f()).done;
            ...
            this.obj.data.Mask = l;
          } else {
            if (this.image.transparency.indexed)
              return (t = !0), this.loadIndexedAlphaChannel();
      ...
      (t.splitAlphaChannel = function() {
        ...
        return this.image.decodePixels(function(t) {
          ...
          return (
            (e.imgData = ri.deflateSync(a)),
            (e.alphaChannel = ri.deflateSync(c)),
            e.finalize()
          );
        });
      }),
      (t.loadIndexedAlphaChannel = function() {
        ...
        return this.image.decodePixels(function(r) {
          for (
            var n = x.alloc(e.width * e.height), i = 0, o = 0, a = r.length;
            o < a;
            o++
          )
            n[i++] = t[r[o]];
          return (e.alphaChannel = ri.deflateSync(n)), e.finalize();
        });
      }),
      (t.decodeData = function() {
        var e = this;
        this.image.decodePixels(function(t) {
          (e.imgData = ri.deflateSync(t)), e.finalize();
        });
      }),
      e
    );
  ...
  ul = (function() {
    ...
    return (
      (e.open = function(e, t) {
        var r;
        if (x.isBuffer(e)) r = e;
        else if (e instanceof ArrayBuffer) r = x.from(new Uint8Array(e));
        else {
          var n = /^data:.+;base64,(.*)$/.exec(e);
          n && (r = x.from(n[1], 'base64'));
        }
        if (255 === r[0] && 216 === r[1]) return new cl(r, t);
        if (137 === r[0] && 'PNG' === r.toString('ascii', 1, 4))
          return new sl(r, t);
  ...
  ll = {
    ...
    embedImage: function(e) {
      var t;
      return (
        'string' == typeof e && (t = this._imageRegistry[e]),
        t || (t = e.width && e.height ? e : this.openImage(e)),
        t.obj || t.embed(this),
        t
      );
    },
    image: function(e, t, r, n) {
      ...
      var l = e instanceof ul ? e : this.embedImage(e);
      (t = null != (s = null != t ? t : n.x) ? s : this.x),
        (r = null != (u = null != r ? r : n.y) ? u : this.y),
        null == this.page.xobjects[l.label] &&
          (this.page.xobjects[l.label] = l.obj);
      ...
      return (
        this.y === r && (this.y += h),
        this.save(),
        this.transform(f, 0, 0, -h, t, r + h),
        this.addContent('/' + l.label + ' Do'),
        this.restore(),
        this
      );
    },
    openImage: function(e) {
      ...
      return (
        'string' == typeof e && (t = this._imageRegistry[e]),
        t ||
          ((t = ul.open(e, 'I' + ++this._imageCount)),
          'string' == typeof e && (this._imageRegistry[e] = t)),
        t
      );
    }
  },
  fl = {
    annotate: function(e, t, r, n, i) {
      for (var o in ((i.Type = 'Annot'),
      (i.Rect = this._convertRect(e, t, r, n)),
      (i.Border = [0, 0, 0]),
      'Link' === i.Subtype && void 0 === i.F && (i.F = 4),
      'Link' !== i.Subtype &&
        null == i.C &&
    ...
    note: function(e, t, r, n, i, o) {
      return (
        ...
        (o.Border = [0, 0, o.borderWidth || 0]),
        delete o.borderWidth,
        this.annotate(e, t, r, n, o)
      );
    },
    goTo: function(e, t, r, n, i, o) {
      return (
        void 0 === o && (o = {}),
        (o.Subtype = 'Link'),
        (o.A = this.ref({ S: 'GoTo', D: new String(i) })),
        o.A.end(),
        this.annotate(e, t, r, n, o)
      );
    },
    link: function(e, t, r, n, i, o) {
      if (
        (void 0 === o && (o = {}), (o.Subtype = 'Link'), 'number' == typeof i)
      ) {
        var a = this._root.data.Pages.data;
        if (!(i >= 0 && i < a.Kids.length))
          throw new Error('The document has no page ' + i);
        (o.A = this.ref({
          S: 'GoTo',
          D: [a.Kids[i], 'XYZ', null, null, null]
        })),
          o.A.end();
      } else (o.A = this.ref({ S: 'URI', URI: new String(i) })), o.A.end();
    ...
    _markup: function(e, t, r, n, i) {
      ...
      var o = this._convertRect(e, t, r, n),
        ...
        u = o[3];
      return (
        (i.QuadPoints = [a, u, s, u, a, c, s, c]),
        (i.Contents = new String()),
        this.annotate(e, t, r, n, i)
      );
    },
  ...
  hl = { top: 0, left: 0, zoom: 0, fit: !1, pageNumber: null, expanded: !1 },
  dl = (function() {
    function e(e, t, r, n, i) {
      ...
      null !== t && (this.outlineData.Parent = t),
        null !== r && (this.outlineData.Title = new String(r)),
        (this.dictionary = this.document.ref(this.outlineData)),
        (this.children = []);
    }
    var t = e.prototype;
    return (
      (t.addItem = function(t, r) {
        void 0 === r && (r = hl);
      ...
      (t.endOutline = function() {
        if (this.children.length > 0) {
          ...
          (this.outlineData.First = e.dictionary),
            (this.outlineData.Last = t.dictionary);
          for (var r = 0, n = this.children.length; r < n; r++) {
            var i = this.children[r];
            r > 0 && (i.outlineData.Prev = this.children[r - 1].dictionary),
              r < this.children.length - 1 &&
                (i.outlineData.Next = this.children[r + 1].dictionary),
              i.endOutline();
          }
        }
  ...
  ml = {
    initOutline: function() {
      this.outline = new dl(this, null, null, null);
    },
    endOutline: function() {
  ...
  pl = { left: 0, center: 1, right: 2 },
  yl = { value: 'V', defaultValue: 'DV' },
  vl = { zip: '0', zipPlus4: '1', zip4: '1', phone: '2', ssn: '3' },
  bl = {
    nDec: 0,
    sepComma: !1,
    negStyle: 'MinusBlack',
  ...
  wl = {
    ...
    formAnnotation: function(e, t, r, n, i, o, a) {
      ...
      (c.Subtype = 'Widget'),
        void 0 === c.F && (c.F = 4),
        this.annotate(r, n, i, o, c);
      var s = this.page.annotations[this.page.annotations.length - 1];
      return this._addToParent(s);
    },
    formText: function(e, t, r, n, i, o) {
      return (
        void 0 === o && (o = {}), this.formAnnotation(e, 'text', t, r, n, i, o)
      );
    },
    formPushButton: function(e, t, r, n, i, o) {
      return (
        void 0 === o && (o = {}),
        this.formAnnotation(e, 'pushButton', t, r, n, i, o)
      );
    },
    formCombo: function(e, t, r, n, i, o) {
      return (
        void 0 === o && (o = {}), this.formAnnotation(e, 'combo', t, r, n, i, o)
      );
    },
    formList: function(e, t, r, n, i, o) {
      return (
        void 0 === o && (o = {}), this.formAnnotation(e, 'list', t, r, n, i, o)
      );
    },
    formRadioButton: function(e, t, r, n, i, o) {
      return (
        void 0 === o && (o = {}),
        this.formAnnotation(e, 'radioButton', t, r, n, i, o)
      );
    },
    formCheckbox: function(e, t, r, n, i, o) {
      return (
        void 0 === o && (o = {}),
        this.formAnnotation(e, 'checkbox', t, r, n, i, o)
      );
    },
    _addToParent: function(e) {
      ...
      return (
        t
          ? (t.data.Kids || (t.data.Kids = []), t.data.Kids.push(e))
          : this._root.data.AcroForm.data.Fields.push(e),
        this
      );
    },
    _fieldDict: function(e, t, r) {
      if ((void 0 === r && (r = {}), !this._acroform))
        throw new Error(
          'Call document.initForms() method before adding form elements to document'
        );
      var n = Object.assign({}, r);
      return (
        null !== t && (n = this._resolveType(t, r)),
        (n = this._resolveFlags(n)),
        (n = this._resolveJustify(n)),
        (n = this._resolveFont(n)),
        (n = this._resolveStrings(n)),
        (n = this._resolveColors(n)),
        ((n = this._resolveFormat(n)).T = new String(e)),
        n.parent && ((n.Parent = n.parent), delete n.parent),
        n
      );
    },
      ...
      if (t && t.type) {
        ...
        if (void 0 !== vl[t.type])
          ...
          if (
            ...
            (r += 'Ex'), (i = String(t.param));
          else if ('time' === t.type) i = String(t.param);
          else if ('number' === t.type) {
            var a = Object.assign({}, bl, t);
            i = String(
              [
                String(a.nDec),
                a.sepComma ? '0' : '1',
        ...
        (e.AA = e.AA ? e.AA : {}),
          (e.AA.K = { S: 'JavaScript', JS: new String(r + '(' + i + ');') }),
          (e.AA.F = { S: 'JavaScript', JS: new String(n + '(' + i + ');') });
      }
    ...
    _resolveColors: function(e) {
      ...
      return (
        t && (e.MK || (e.MK = {}), (e.MK.BG = t)),
        (t = this._normalizeColor(e.borderColor)) &&
          (e.MK || (e.MK = {}), (e.MK.BC = t)),
    ...
    _resolveFlags: function(e) {
      ...
      return (
        Object.keys(e).forEach(function(r) {
          gl[r] && ((t |= gl[r]), delete e[r]);
        }),
        0 !== t && ((e.Ff = e.Ff ? e.Ff : 0), (e.Ff |= t)),
        e
      );
    },
    _resolveJustify: function(e) {
      ...
      return (
        void 0 !== e.align &&
          ('number' == typeof pl[e.align] && (t = pl[e.align]), delete e.align),
        0 !== t && (e.Q = t),
        e
      );
    },
    _resolveFont: function(e) {
      if (
        ...
        var t = e.fontSize || 0;
        (e.DR.Font[this._font.id] = this._font.ref()),
          (e.DA = new String('/' + this._font.id + ' ' + t + ' Tf 0 g'));
      }
      return e;
    },
    _resolveStrings: function(e) {
      ...
      function r(e) {
        if (Array.isArray(e))
          for (var r = 0; r < e.length; r++)
            'string' == typeof e[r] ? t.push(new String(e[r])) : t.push(e[r]);
      }
      return (
        r(e.Opt),
        e.select && (r(e.select), delete e.select),
        t.length && (e.Opt = t),
        Object.keys(yl).forEach(function(t) {
          void 0 !== e[t] && ((e[yl[t]] = e[t]), delete e[t]);
        }),
  ...
  _l = {
    file: function(e, t) {
      ...
      var r,
        n = { Type: 'EmbeddedFile', Params: {} };
      if (!e) throw new Error('No src specified');
      if (x.isBuffer(e)) r = e;
      else if (e instanceof ArrayBuffer) r = x.from(new Uint8Array(e));
      else {
        var i;
        if (!(i = /^data:(.*);base64,(.*)$/.exec(e)))
          throw new Error('Could not find file ' + e);
        i[1] && (n.Subtype = i[1].replace('/', '#2F')),
          (r = x.from(i[2], 'base64'));
      }
      t.creationDate instanceof Date &&
        (n.Params.CreationDate = t.creationDate),
        t.modifiedDate instanceof Date && (n.Params.ModDate = t.modifiedDate),
        t.type && (n.Subtype = t.type.replace('/', '#2F'));
      var o,
        a = s(h.lib.WordArray.create(new Uint8Array(r)));
      (n.Params.CheckSum = new String(a)),
        (n.Params.Size = r.byteLength),
        this._fileRegistry || (this._fileRegistry = {});
      var c,
        u,
        l = this._fileRegistry[t.name];
      l &&
      ((u = l),
      (c = n).Subtype === u.Subtype &&
        c.Params.CheckSum.toString() === u.Params.CheckSum.toString() &&
        c.Params.Size === u.Params.Size &&
        c.Params.CreationDate === u.Params.CreationDate &&
        c.Params.ModDate === u.Params.ModDate)
        ? (o = l.ref)
        : ((o = this.ref(n)).end(r),
          (this._fileRegistry[t.name] = f({}, n, { ref: o })));
      var d = {
        Type: 'Filespec',
        F: new String(t.name),
        EF: { F: o },
      ...
      t.description && (d.Desc = new String(t.description));
      var m = this.ref(d);
      return m.end(), t.hidden || this.addNamedEmbeddedFile(t.name, m), m;
    }
  };
var Ol = function(e) {
  ...
  Sl = (function(t) {
    function r(e) {
      ...
      (r.compress = null == r.options.compress || r.options.compress),
        (r._pageBuffer = []),
        ...
        (r._ended = !1),
        (r._offset = 0);
      var n = r.ref({ Type: 'Pages', Count: 0, Kids: [] }),
        i = r.ref({ Dests: new gu() });
      if (
        ((r._root = r.ref({ Type: 'Catalog', Pages: n, Names: i })),
        r.options.lang && (r._root.data.Lang = new String(r.options.lang)),
        r.options.pageLayout &&
          (r._root.data.PageLayout = Ol(r.options.pageLayout)),
        r.options.pageMode && (r._root.data.PageMode = Ol(r.options.pageMode)),
        (r.page = null),
        r.initColor(),
        r.initVector(),
        r.initFonts(),
      ...
      return (
        r.options.displayTitle &&
          (r._root.data.ViewerPreferences = r.ref({ DisplayDocTitle: !0 })),
        (r._id = Su.generateFileID(r.info)),
        r._write('%PDF-' + r.version),
        r._write('%ÿÿÿÿ'),
        !1 !== r.options.autoFirstPage && r.addPage(),
        r
      );
    }
    e(r, t);
    ...
    return (
      (n.addPage = function(e) {
        null == e && (e = this.options),
          ...
          (this.page = new Ou(this, e)),
          this._pageBuffer.push(this.page);
        var t = this._root.data.Pages.data;
        return (
          t.Kids.push(this.page.dictionary),
          t.Count++,
      ...
      (n.addNamedDestination = function(e) {
        for (
          ...
          r[n - 1] = arguments[n];
        0 === r.length && (r = ['XYZ', null, null, null]),
          'XYZ' === r[0] && null !== r[2] && (r[2] = this.page.height - r[2]),
          r.unshift(this.page.dictionary),
          this._root.data.Names.data.Dests.add(e, r);
      }),
      (n.addNamedEmbeddedFile = function(e, t) {
        this._root.data.Names.data.EmbeddedFiles ||
          (this._root.data.Names.data.EmbeddedFiles = new gu({ limits: !1 })),
          this._root.data.Names.data.EmbeddedFiles.add(e, t);
      }),
      (n.addNamedJavaScript = function(e, t) {
        this._root.data.Names.data.JavaScript ||
          (this._root.data.Names.data.JavaScript = new gu());
        var r = { JS: new String(t), S: 'JavaScript' };
        this._root.data.Names.data.JavaScript.add(e, r);
      }),
      (n.ref = function(e) {
        var t = new mu(this, this._offsets.length + 1, e);
      ...
      (n.addContent = function(e) {
        return this.page.write(e), this;
      }),
      (n._refEnd = function(e) {
        if (
  ...
  El = function(e) {
    Object.assign(Sl.prototype, e);
  };
El(Fu), El(Ku), El(nl), El(ol), El(ll), El(fl), El(ml), El(wl), El(_l);
export { rl as EmbeddedFont, el as PDFFont, tl as StandardFont, Sl as default };
