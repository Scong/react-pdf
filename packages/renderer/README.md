<p align="center">
  ...
  <p align="center">
    <a href="https://www.npmjs.com/package/scong-react-fork-pdf-renderer">
      <img src="https://img.shields.io/npm/v/scong-react-fork-pdf-renderer.svg" />
    </a>
...
```sh
yarn add scong-react-fork-pdf-renderer
```
...
import {
  ...
  View,
  StyleSheet,
} from 'scong-react-fork-pdf-renderer';
...
import { PDFViewer } from 'scong-react-fork-pdf-renderer';
...
```jsx
import ReactPDF from 'scong-react-fork-pdf-renderer';
...
![](https://img.shields.io/npm/dt/scong-react-fork-pdf-renderer.svg?style=flat)
